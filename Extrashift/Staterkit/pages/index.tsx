                                    ...
                                    <Tab.Pane eventKey="nextjs" className='border-0'>
                                        <div className="card-body p-5 pt-1">
                                            ...
                                            <div className="text-center">
                                                <p className="text-muted mt-3">Dont have an account? <Link href="#!" className="text-primary">Sign Up</Link></p>
                                            </div>
                                    ...
                                    <Tab.Pane eventKey="firebase" className='border-0'>
                                        <div className="card-body p-5 pt-1">
                                            ...
                                            <div className="row gy-3">
                                                ...
                                                <Col xl={12} className="mb-2">
                                                    <Form.Label htmlFor="signin-password" className="text-default d-block">Password<Link href="#!" className="float-end text-danger">Forget password ?</Link></Form.Label>
                                                    <div className="input-group">
                                                        <Form.Control className="form-control-lg" id="signin-password"
