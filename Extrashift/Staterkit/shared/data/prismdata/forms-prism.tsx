...
<Form.Control type="text" className="" placeholder="Username"
    aria-label="Username" aria-describedby="addon-wrapping"/>
                 ...
                 /*------ Form-Select (prism-code for showcode purpose) Start ------*/
...
<option defaultValue="5">Five</option>
                 ...
                 /*------ Form-Select (prism-code for showcode purpose) End ------*/


                 /*------ Range-Slider (prism-code for showcode purpose) Start ------*/
...
step="0.5" id="customRange3"/>`;
                 ...
                 /*------ Range-Slider (prism-code for showcode purpose) End ------*/

                 /*------ File-Uploads (prism-code for showcode purpose) Start ------*/
...
<Form.Control type="file" size="lg" />
                 ...
                 /*------ File-Uploads (prism-code for showcode purpose) End ------*/

                 /*------ Floating-Labels (prism-code for showcode purpose) Start ------*/
...
<Col xl={4} className="">
    <Form.Floating className="mb-4 floating-danger">
        ...
        <Form.Label htmlFor="floatingInputdanger">danger</Form.Label>
                 ...
                 /*------ Floating-Labels (prism-code for showcode purpose) End ------*/
...
<div className="col-12">
    <Button variant='primary' type="submit" className="">Sign in</Button>
                 ...
                 /*------ Form-Validations (prism-code for showcode purpose) Start ------*/
...
<div className="mb-3">
    <Button variant='primary' className="btn " type="submit" disabled>Submit
        form</Button>
                 ...
                 /*------ Form-Validations (prism-code for showcode purpose) End ------*/
