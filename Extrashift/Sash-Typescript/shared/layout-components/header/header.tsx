...
const Header = ({ local_varaiable, ThemeChanger }: any) => {
  ...
  const handleContinueShopping = async () => {
    ...
    fetchCartItems();
    await router.push(`/components/pages/ecommerce/products/`);
  };
                    ...
                    <div className="mt-3">
                      ...
                      <ul className="ps-0">
                        <li className="p-1 d-flex align-items-center text-muted mb-3 search-app">
                          <Link className="d-inline-flex align-items-center" href="/components/apps/full-calender"><i className="fe fe-calendar me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i><span>Calendar</span></Link>
                        </li>
                        <li className="p-1 d-flex align-items-center text-muted mb-3 search-app">
                          <Link className="d-inline-flex align-items-center" href="/components/pages/email/mail-inbox"><i className="fe fe-mail me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i><span>Mail</span></Link>
                        </li>
                        <li className="p-1 d-flex align-items-center text-muted mb-3 search-app">
                          <Link className="d-inline-flex align-items-center" href="/components/ui-elements/buttons"><i className="fe fe-globe me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i><span>Buttons</span></Link>
                        </li>
                      </ul>
                    </div>
                    <div className="mt-3">
            ...
            <Dropdown className="header-element cart-dropdown" autoClose="outside" align={"end"}>
              ...
              <Dropdown.Menu className="main-header-dropdown dropdown-menu-end" data-popper-placement="none">
                        ...
                        <div className="d-flex align-items-start cart-dropdown-item">
                          ...
                          <div className="flex-grow-1">
                            <div className="d-flex align-items-start mb-0">
                              <div>
                                <Link className="mb-0 fs-13 text-dark fw-semibold" href="/components/pages/ecommerce/cart">{idx.class}</Link>
                ...
                <div className={`p-3 empty-header-item border-top ${cartItemCount === 0 ? 'd-none' : 'd-flex'}`}>
                  <Link href="/components/pages/ecommerce/checkout" className="btn btn-primary btn-pill w-sm btn-sm  fs-16"><i className="fe fe-check-circle me-2 d-inline-flex"></i>checkout</Link>
                ...
                <div className={`p-5 empty-item ${cartItemCount === 0 ? 'd-block' : 'd-none'}`}>
                  <div className="text-center">
                    ...
                    <Link href={`/components/pages/ecommerce/products/`} className="btn btn-primary btn-wave btn-sm m-1" data-abc="true" onClick={handleContinueShopping}>
            ...
            <Dropdown className="header-element notifications-dropdown" autoClose="outside" align={"end"}>
              ...
              <Dropdown.Menu className="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                    ...
                    <Dropdown.Item as="li" className="dropdown-item border-bottom" key={Math.random()}>
                      <div className="d-flex align-items-start">
                        ...
                        <div className="flex-grow-1 d-flex align-items-center my-auto">
                          <div>
                            <p className="mb-0 fw-semibold"><Link href="/components/pages/notifications">{idx.class}</Link></p>
                ...
                <div className={`p-3 empty-header-item border-top justify-content-center ${cartItemCount1 === 0 ? 'd-none' : 'd-flex'}`}>
                  <Link href="/components/pages/notifications" className="">View All Notifications</Link>
                </div>
            ...
            <Dropdown className="header-element message-dropdown" autoClose="outside" align={"end"}>
              ...
              <Dropdown.Menu className="main-header-dropdown dropdown-menu dropdown-menu-end" data-popper-placement="none">
                        ...
                        <div className="d-flex align-items-start">
                          ...
                          <div className="w-100">
                            <div className="flex-grow-1 d-flex align-items-centermy-auto">
                              <div>
                                <h6 className="mb-0 fw-semibold fs-14"><Link href="/components/pages/chat">{idx.class}</Link></h6>
                              </div>
                ...
                <div className={`p-3 empty-header-item border-top justify-content-center ${cartItemCount2 === 0 ? 'd-none' : 'd-block'}`}>
                  <Link href="/components/pages/chat" className="">View All Messages</Link>
                </div>
