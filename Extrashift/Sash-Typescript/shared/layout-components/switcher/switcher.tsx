                                        ...
                                        <div className="row switcher-style gx-0 pb-2 gy-2">
                                            <div className="col-sm-6">
                                                <div className="form-check switch-select">
                                                    ...
                                                    <input className="form-check-input" type="radio" name="sidemenu-layout-styles"
                                                        ...
                                                        checked={local_varaiable.dataVerticalStyle == 'default' || local_varaiable.dataVerticalStyle == 'overlay'} onChange={(_e) => { }}
                                            ...
                                            <div className="col-sm-6">
                                                <div className="form-check switch-select">
                                                    ...
                                                    <input className="form-check-input" type="radio" name="sidemenu-layout-styles"
                                                        checked={local_varaiable.toggled == 'double-menu-open'} onChange={(_e) => { }}
                                    ...
                                    <div>
                                        <div className="theme-colors">
                                            ...
                                            <div className="d-flex switcher-style pb-2">
                                                ...
                                                <div className="form-check switch-select me-3">
                                                <OverlayTrigger placement="top" overlay={<Tooltip>Gardient Menu</Tooltip>}>
                                        ...
                                        <div className="theme-colors">
                                            ...
                                            <div className="d-flex switcher-style pb-2">
                                                ...
                                                <div className="form-check switch-select me-3">
                                                <OverlayTrigger placement="top" overlay={<Tooltip>Gardient Header</Tooltip>}>
                                                    <input className="form-check-input color-input color-gradient" data-bs-toggle="tooltip"
                                                ...
                                                <div className="form-check switch-select me-3">
                                                <OverlayTrigger placement="top" overlay={<Tooltip>Transperant Header</Tooltip>}>
