...
export const Productoptions1:Selectdata[] = [
...
export const Productoptions3:Selectdata[] = [
	{ value: "", label: "Select" },
...
export const Productoptions4:Selectdata[] = [
	{ value: "", label: "Select" },
...
export const Productoptions5:Selectdata[] = [
...
export const Productoptions6:Selectdata[] = [
	{ value: "Select", label: "Select" },
	{ value: "Published", label: "Published" },
	{ value: "Scheduled", label: "Scheduled" }
];
export const Productoptions7:Selectdata[] = [
	{ value: "Relaxed", label: "Relaxed" },
	{ value: "Solid", label: "Solid" },
	{ value: "Washed", label: "Washed" },
	{ value: "Plain", label: "Plain" }
];
export const Productoptions8:Selectdata[] = [
	{ value: "Select", label: "Select" },
