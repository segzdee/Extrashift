...
export class Basicarea extends React.Component<{}, spark3> {
...
export class Spiline extends React.Component<{}, spark3> {
    constructor(props: {} | Readonly<{}>) {
        super(props)
...
export class Negative extends React.Component<{}, spark3> {
    constructor(props: {} | Readonly<{}>) {
        super(props)
...
var generateDayWiseTimeSeries = function (baseval: number, count: number, yrange: any) {
    var i = 0;
    var series = [];
    while (i < count) {
        var x = baseval;
...
export class Stacked extends React.Component<{}, spark3> {
    constructor(props: {} | Readonly<{}>) {
        super(props)
        ...
        this.state = {
            ...
            options: {
                chart: {
                    ...
                    stacked: true,
                    events: {
                        selection: function (e: { xaxis: { min: string | number | Date; }; }) {
                            console.log(new Date(e.xaxis.min))
                        }
                    },
                },
                colors: ['#6c5ffc', '#23b7e5', '#e6eaeb'],
                grid: {
                    borderColor: '#f2f5f7',
                },
                dataLabels: {
...
export class Nullarea extends React.Component<{}, spark3> {
    constructor(props: {} | Readonly<{}>) {
        super(props)
...
export class Datetimexaxis extends React.Component<{}, spark3> {
    constructor(props: {} | Readonly<{}>) {
        super(props)
