...
<Accordion.Body><strong>This is the third item's accordion body.</strong> It is hidden
  ...
  transition  does limit overflow.
                 ...
                 /*------ Carouse(prism-code for showcode purpose) Start ------*/
...
`
                 ...
                 /*------ Modal (prism-code for showcode purpose) Start ------*/
...
export const modal15 = `<Row className="row-sm">
  ...
  <Rodal onClose={() => viewDemoClose1("show9")} visible={animation9} animation='slideRight' height={330}>
    ...
    <div className='modal-footer'>
      ...
      <Button variant="secondary" onClick={() => viewDemoClose1("show9")}>Close</Button>
                 ...
                 /*------ Modal (prism-code for showcode purpose) End ------*/
