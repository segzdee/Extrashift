...
&lt;div className="mb-2"&gt;&lt;/div&gt;
 &lt;/div&gt;
  &lt;button type="button" className="btn btn-primary" id="liveAlertBtn"&gt;Show live
  alert
   &lt;/button&gt;`;
...
export const alert4=` {solidalert.map((idx, alt3) => (
    <Alert variant={idx.class} className={"alert alert-dismissible fade show {idx.color}"} key={alt3}>
        ...
        <Button variant='' type="button" className={"btn-close {idx.color1}"} data-bs-dismiss="alert" aria-label="Close"
            onClick={() => handleRemove(idx.id)}><i className={"bi bi-x &#60{idx.color2}"}></i></Button>
    </Alert>
))}`;

export const alert5 = `  {outlinealert.map((idx, alt4) => (
...
export const alert6 = `&lt;div className="alert alert-solid-primary shadow-sm alert-dismissible fade show"&gt;
...
&lt;div className="alert alert-solid-primary shadow alert-dismissible fade show"&gt;
A simple solid primary alert with normal shadow—check it out!
&lt;button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i className="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;

&lt;div className="alert alert-solid-primary shadow-lg alert-dismissible fade show"&gt;
A simple solid primary alert with large shadow—check it out!
&lt;button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i className="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;

&lt;div className="alert alert-solid-secondary shadow-sm alert-dismissible fade show"&gt;
A simple solid secondary alert with small shadow—check it out!
&lt;button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i className="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;&lt;/div&gt;

&lt;div className="alert alert-solid-secondary shadow alert-dismissible fade show"&gt;
A simple solid secondary alert with normal shadow—check it out!
&lt;button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i className="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;&lt;/div&gt;

&lt;div className="alert alert-solid-secondary shadow-lg alert-dismissible fade show"&gt;
A simple solid secondary alert with large shadow—check it out!
&lt;button type="button" className="btn-close" data-bs-dismiss="alert" aria-label="Close"&gt;&lt;i className="bi bi-x"&gt;&lt;/i&gt;&lt;/button&gt;
&lt;/div&gt;}`
export const alert7 = `&lt;div className="alert alert-primary shadow-sm"A simple primary alert with small shadow—check it out!&lt;/div&gt;

&lt;div className="alert alert-primary shadow"&gt;A simple primary alert with normal shadow—check it out!&lt;/div&gt;

&lt;div className="alert alert-primary shadow-lg"&gt;A simple primary alert with large shadow—check it out!&lt;/div&gt;

&lt;div className="alert alert-secondary shadow-sm"&gt;A simple secondary alert with small shadow—check it out!&lt;/div&gt;

&lt;div className="alert alert-secondary shadow"&gt;A simple secondary alert with normal shadow—check it out!&lt;/div&gt;

&lt;div className="alert alert-secondary shadow-lg"&gt;A simple secondary alert with large shadow—check it out!&lt;/div&gt;`
...
export const alert12 = `  <Alert className=" alert-primary d-flex align-items-center" role="alert">
...
export const alert13 = ` {customized1alert.map((idx) => (
...
export const alert14 = `  {imagesalert.map((idx) => (
    <Alert variant={idx.color} className="alert alert-img alert-dismissible fase show rounded-pill flex-wrap" role="alert" key={Math.random()}>
        ...
        ><i className={"bi bi-x &#60{idx.data}"}></i></Button>
    </Alert>
))}`
export const alert15 = ` {avataralert.map((idx) => (
    <Alert variant={idx.color} className="alert alert-img alert-dismissible fase show flex-wrap" role="alert" key={Math.random()}>
        <div className={"avatar avatar-&#60{idx.class} me-3"}>
            <img src={idx.src1} alt="img" />
        </div>
        <div>A simple {idx.color} alert with image—check it out!</div>
...
export const alert22 = `{additionalcontentalert.map((idx) => (
    <Col xl={6} key={Math.random()}>
        <Alert variant={idx.class} className="alert  overflow-hidden p-0" role="alert">
            <div className={"p-3 bg-#067{idx.class}  d-flex justify-content-between"}>
            ...
            <div className="p-3">
                <p className="mb-0">{idx.text2}<Link href="#!" className="fw-semibold text-decoration-underline">{idx.text3}</Link></p>
                 ...
                 /*------ Badges (prism-code for showcode purpose) Start ------*/
...
<Badge className="badge rounded-pill bg-success">32</Badge>
                 ...
                 /*------ Badges (prism-code for showcode purpose) End ------*/

                 /*------ Breadcrumbs (prism-code for showcode purpose) Start ------*/
...
<Breadcrumb className="breadcrumb mb-0">
    ...
    <Breadcrumb.Item active className="active" aria-current="page">Library</Breadcrumb.Item>
                 ...
                 /*------ Breadcrumbs (prism-code for showcode purpose) End ------*/
...
<div className="d-grid gap-2 d-md-flex justify-content-md-end">
    ...
    <Button variant='purple' className="btn  btn-wave" type="button">Button</Button>
                 ...
                 /*------ Dropdown (prism-code for showcode purpose) Start ------*/
 ...
 <Dropdown.Menu show className="dropdown-menu p-4 text-muted" style={{ maxWidth: 200 }}>
     ...
     <p className="mb-0">
         And this is more example text.
                 ...
                 /*------ Dropdown (prism-code for showcode purpose) End ------*/
...
`<OverlayTrigger placement='top' trigger="click" overlay={<Popover className='popover-secondary only-body' id="tooltip-disabled">
 ...
 <Link className="me-4 avatar avatar-md br-5" href="#!" >
 ...
 <Link className="me-4 avatar avatar-md rounded-circl" href="#!" >
...
<Button variant={idx.color} className="" type="button" disabled key={Math.random()}>
    ...
    Loading...
                 ...
                 /*------ Toast (prism-code for showcode purpose) Start ------*/
...
<Toast id="topleft-Toast" className="toast colored-toast bg-primary-transparent text-primary"
 onClose={() => setShow13(false)} show={show13} delay={3000} autohide>
    <Toast.Header className="toast-header bg-primary text-fixed-white">
        ...
        <strong className="me-auto">Sash</strong>
...
<div aria-live="polite" aria-atomic="true"
    ...
    <Toast show={showK} onClose={toggleShowK} className="toast fade show shadow-lg">
        ...
        <Toast.Body> Hello, world! This is a toast message.</Toast.Body>
                 ...
                 /*------ Toast (prism-code for showcode purpose) end ------*/
