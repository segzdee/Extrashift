...
export const LightButtons:Buttons[] = [
...
export const OutlineButtons:Buttons[]= [
...
export const GradientButtons:Buttons[]= [
...
export const GhostButtons:Buttons[]= [
...
export const SocialIconButtons:Socialbuttons[]= [
	{ id: 1, class: "facebook" },
	{ id: 2, class: "twitter" },
...
export const ColoredButtons:color[] = [
	{ id: 1, class: "primary" },
