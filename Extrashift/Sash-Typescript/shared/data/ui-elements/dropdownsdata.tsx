...
export const SingleButtons: dropdowndata[] = [
	{ id: 1, class: "primary" },
...
export const OutlineButtons: dropdowndata[] = [
...
export const SplitButtonsdata: dropdowndata[] = [
	{ id: 1, class: "primary" },
	{ id: 2, class: "secondary" },
	{ id: 3, class: "info" },
	{ id: 4, class: "success" },
...
export const SizingButtons: sizingbutton[] = [
