...
import { Button, Card, Nav, OverlayTrigger, Pagination, Tooltip } from 'react-bootstrap';
...
export class TotalUser extends Component<{}, spark3> {
  ...
  render() {
    return (
      ...
      <div id="total-userchart">
        <ReactApexChart className="h-8 chart-dropshadow" options={this.state.options} series={this.state.series} type="line" height={60} width={80} />
      </div>
...
export class TotalProfit extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
  ...
  render() {
    return (
      ...
      <div id="total-profitchart">
        <ReactApexChart className="h-8 chart-dropshadow" options={this.state.options} series={this.state.series} type="line" height={60} width={96} />
      </div>
...
export class Totalexpenses extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
export class TotalCost extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
...
//Recent Orders
export class RecentOrder extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
    ...
    this.state = {
      ...
      series: [
        {
          data: [27, 50, 28, 50, 28, 30, 22,30],
          color: '#05C3FB',
        }, {
          data: [32, 58, 68, 65, 40, 68, 58,48],
          color: '#EC82EF',
        }],
...
export class RecentOrder2 extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props)
    this.state = {
      chartData: {
  ...
  render() {
    return (
      <div id="chart">
        <ReactApexChart options={this.state.options} series={this.state.chartData.series} type="line" height={210}  />
      </div>
    );
  }
}
...
export const Activity: activity[] = [
  { id: 1, class: "Task Finished", date: "09 July 2023", data: "Adam Berry finished task on", role: " Project Management", color: "primary" },
  { id: 1, class: "New Comment", date: "05 July 2023", data: "Victoria commented on Project", role: " AngularJS Template", color: "secondary" },
  { id: 1, class: "New Comment", date: "25 June 2023", data: "Victoria commented on Project", role: " AngularJS Template", color: "success" },
  { id: 1, class: "Task Overdue", date: "14 June 2023", data: "Petey Cruiser finished task", role: " Integrated management", color: "warning" },
  { id: 1, class: "Task Overdue", date: "29 June 2023", data: "Petey Cruiser finished task", role: " Integrated management", color: "danger" },
  { id: 1, class: "Task Finished", date: "09 July 2023", data: "Adam Berry finished task on ", role: " Project Management", color: "info" },
]
...
const i = <span className={` align-middle badge bg-success-transparent rounded-pill text-success p-2 px-3`}>Shipped</span>
const t = <span className={` align-middle badge bg-danger-transparent rounded-pill text-danger p-2 px-3`}>Cancelled</span>
const s = <span className={` align-middle badge bg-warning-transparent rounded-pill text-warning p-2 px-3`}>Pending</span>
const d = <div className='d-flex align-items-center'><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/9.jpg" /><div className='ms-1 d-block'><h6 className='mb-0 fs-14'>Headsets</h6></div></div>
const e = <div className='d-flex align-items-center'><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/11.jpg" /><div className='ms-1 d-block'><h6 className='mb-0 fs-14'>Flower Pot</h6></div></div>
const f = <div className='d-flex align-items-center'><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/4.jpg" /><div className='ms-1 d-block'><h6 className='mb-0 fs-14'>Pen Drive</h6></div></div>
const g = <div className='d-flex align-items-center'><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/8.jpg" /><div className='ms-1 d-block'><h6 className='mb-0 fs-14'>New Bowl</h6></div></div>
const h = <div className='d-flex align-items-center'><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/6.jpg" /><div className='ms-1 d-block'><h6 className='mb-0 fs-14'>Leather Watch</h6></div></div>
const j = <div className='d-flex align-items-center'><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/1.jpg" /><div className='ms-1 d-block'><h6 className='mb-0 fs-14'>Digital Camera</h6></div></div>
const l = <div className='d-flex align-items-center'><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/10.jpg" /><div className='ms-1 d-block'><h6 className='mb-0 fs-14'>Earphones</h6></div></div>
const m = <div className='d-flex align-items-center'><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/2.jpg" /><div className='ms-1 d-block'><h6 className='mb-0 fs-14'>Shoes</h6></div></div>


const data1 = <><OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
  <i className="fe fe-edit fs-18 text-primary me-4 d-inline-block"></i>
    ...
    <div className="table-responsive">
      <>
        <div className="d-sm-flex">
          <select
            className=" mb-4 selectpage form-select border me-1"
            value={pageSize}
        ...
        >
          <thead>
          <tr>
            <th scope="col" className="">Tracking Id</th>
              ...
              return (
                <tr className="" {...row.getRowProps()} key={Math.random()}>
                  {row.cells.map((cell: any) => {
                    return (
                      <td {...cell.getCellProps()} key={Math.random()} className='fw-semibold'>{cell.render("Cell")}</td>
                    );
                  })}
                </tr>
              );
        ...
        <div className="d-block d-sm-flex mt-4 align-items-center">
          ...
          <Pagination.Item className="" onClick={() => gotoPage(0)} >Previous</Pagination.Item> 
          <Pagination.Item className="active" onClick={() => { previousPage();}}  >1</Pagination.Item> 
          <Pagination.Item className="" onClick={() => {previousPage();}} >2</Pagination.Item> 
          <Pagination.Item className="" onClick={() => gotoPage(pageCount - 1)}>Next</Pagination.Item> 
          </Pagination> 
          </Nav>
          </span>
        </div>
...
const a = <span className={` align-middle badge bg-success-transparent rounded-pill text-success p-2 px-3`}>Shipped</span>

const img = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/9.jpg" /><span>Headsets</span></div>
const img1 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/11.jpg" /><span>Flower Pot</span></div>
const img2 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/4.jpg" /><span>Pen Drive</span></div>
const img3 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/8.jpg" /><span>New Bowl</span></div>
const img4 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/6.jpg" /><span>Leather Watch</span></div>
const img5 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/1.jpg" /><span> Digital Camera</span></div>
const img6 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/10.jpg" /><span> Earphones</span></div>
const img7 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/2.jpg" /><span>  Shoes</span></div>
const data2 = <div className="d-flex align-items-center"><OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
  <i className="fe fe-edit fs-18 text-primary me-4 d-inline-block"></i>
</OverlayTrigger><OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>}>
                ...
                {page.map((row: any) => {
                  ...
                  return (
                    <tr className="" {...row.getRowProps()} key={Math.random()}>
                      {row.cells.map((cell: any) => {
                        return (
                          <td {...cell.getCellProps()} className='fw-semibold' key={Math.random()}>{cell.render("Cell")}</td>
                        );
                      })}
                    </tr>
                  );
...
const b = <span className={`text-center align-middle badge bg-warning-transparent rounded-pill text-warning p-2 px-3`}>Pending</span>

const imge = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/9.jpg" /><span>Headsets</span></div>
const imge1 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/11.jpg" /><span>Flower Pot</span></div>
const imge2 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/4.jpg" /><span>Pen Drive</span></div>
const imge3 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/8.jpg" /><span>New Bowl</span></div>
const imge4 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/6.jpg" /><span>Leather Watch</span></div>
const imge5 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/1.jpg" /><span> Digital Camera</span></div>
const imge6 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/10.jpg" /><span> Earphones</span></div>
const imge7 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/2.jpg" /><span>  Shoes</span></div>
const data3 = <div className="d-flex align-items-center"><OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
  <i className="fe fe-edit fs-18 text-primary me-4 d-inline-block"></i>
</OverlayTrigger><OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>}>
    <i className="fe fe-trash-2 text-danger fs-18 me-4"></i>
  </OverlayTrigger></div>
...
const c = <span className={`align-middle badge bg-danger-transparent rounded-pill text-danger p-2 px-3`}>Cancelled</span>

const imges = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/9.jpg" /><span>Headsets</span></div>
const imges1 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/11.jpg" /><span>Flower Pot</span></div>
const imges2 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/4.jpg" /><span>Pen Drive</span></div>
const imges3 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/8.jpg" /><span>New Bowl</span></div>
const imges4 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/6.jpg" /><span>Leather Watch</span></div>
const imges5 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/1.jpg" /><span> Digital Camera</span></div>
const imges6 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/10.jpg" /><span> Earphones</span></div>
const imges7 = <div className="d-flex align-items-center"><img className='w-5 h-5 br-5 me-2' src="../../../assets/images/ecommerce/orders/2.jpg" /><span>  Shoes</span></div>
const data4 = <div className="d-flex align-items-center"><OverlayTrigger placement="top" overlay={<Tooltip>Edit</Tooltip>}>
  <i className="fe fe-edit fs-18 text-primary me-4 d-inline-block"></i>
</OverlayTrigger><OverlayTrigger placement="top" overlay={<Tooltip>Delete</Tooltip>}>
    <i className="fe fe-trash-2 text-danger fs-18 me-4"></i>
  </OverlayTrigger></div>
...
//Recent Orders
export class RecentOrder1 extends Component<{}, spark3> {
  constructor(props: {} | Readonly<{}>) {
    super(props);
