import { Applicants, BTC, DASH, ETH, GLM, Salesdata, Sessions, Targetreport, TotalRevenue, WorldMap } from '@/shared/data/widgets/widgetsdata'
import Pageheader from '@/shared/layout-components/pageheader/pageheader'
import Seo from '@/shared/layout-components/seo/seo'
import Link from 'next/link'
import React, { Fragment } from 'react'
import { Button, Card, Col, Dropdown, ListGroup, Nav, ProgressBar, Row, Tab, TabContainer, Table } from 'react-bootstrap'
                        ...
                        <Col xl={6}>
                            <Card className="custom-card">
                                <Card.Body>
                                    ...
                                    <div className="">
                                        <ProgressBar className="progress progress-xs mb-4 bg-success" role="progressbar" now={25} aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
                                    </div>
                                    ...
                                    <div className="">
                                        <ProgressBar className="progress progress-xs mb-2 bg-success" role="progressbar" now={75} aria-valuenow={25} aria-valuemin={0} aria-valuemax={100} />
                                    </div>
                                </Card.Body>
                            ...
                            <Card className="custom-card">
                                <Card.Body>
                                    <div className="d-flex align-items-center mb-3">
                                        ...
                                        <div>
                                            <Link href="#!" className="btn btn-icon btn-primary-light rounded-pill btn-wave transform-arrow" data-bs-toggle="tooltip" aria-label="View All"><i className="bi bi-chevron-right transform-arrow"></i></Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="d-flex align-items-center justify-content-between">
                                        <div className="avatar-list-stacked">
                                            <Link href="#!" className="avatar avatar-sm rounded-circle overflow-hidden" data-bs-toggle="tooltip" aria-label="Mis x matched"><img src="../../../assets/images/faces/2.jpg" alt="img" className="w-100" /></Link>
                                            <Link href="#!" className="avatar avatar-sm rounded-circle overflow-hidden" data-bs-toggle="tooltip" aria-label="Barbel Bob"><img src="../../../assets/images/faces/12.jpg" alt="img" className="w-100" /></Link>
                                            <Link href="#!" className="avatar avatar-sm rounded-circle overflow-hidden" data-bs-toggle="tooltip" aria-label="Phan Rel"><img src="../../../assets/images/faces/20.jpg" alt="img" className="w-100" /></Link>
                                            <Link href="#!" className="avatar avatar-sm rounded-circle overflow-hidden bg-primary text-fixed-white" data-bs-toggle="tooltip">+4</Link>
                                        </div>
                                    </div>
                                </Card.Body>
                            </Card>
                                ...
                                <Card.Body>
                                    <div className="d-flex align-items-center">
                                        <div className="flex-fill">
                                            ...
                                            <p className="mb-0 fs-11"><Link href="#!" className="text-success text-decoration-underline">View All</Link></p>
                                        </div>
                                        <div className="ms-2">
                            ...
                            <Card className="custom-card">
                                <Card.Body className="p-0">
                                    <div className="p-3">
                                        ...
                                        <div className="d-flex align-items-center">
                                            <Link href="#!" className="flex-fill btn btn-sm btn-light me-2">Short</Link>
                                            <Link href="#!" className="flex-fill btn btn-sm btn-primary-light">Buy</Link>
                                        </div>
                                    </div>
                                </Card.Body>
                            </Card>
                    ...
                    <Card className="custom-card">
                        <Card.Body>
                            <div className="d-flex align-items-top justify-content-between mb-4">
                                ...
                                <Dropdown>
                                    <Dropdown.Toggle as="a" href="#!" data-bs-toggle="dropdown" className="btn btn-icon btn-sm btn-light no-caret"><i className="ti ti-dots"></i></Dropdown.Toggle>
                                    <Dropdown.Menu align="end" className="dropdown-menu">
                                        <Dropdown.Item><Link href="#!" className="">Action</Link></Dropdown.Item>
                                        <Dropdown.Item><Link href="#!" className="">Another Action</Link></Dropdown.Item>
                                        <Dropdown.Item><Link href="#!" className="">Something Else Here</Link></Dropdown.Item>
                                    </Dropdown.Menu>
                                </Dropdown>
                            </div>
                        ...
                        <Card className={`custom-card border-top-card border-top-${idx.color} rounded-0`}>
                            <Card.Body>
                                <div className="text-center">
                                    ...
                                    <p className="fs-14 fw-semibold mb-2">{idx.heading}</p>
                                    <div className="d-flex align-items-center justify-content-center flex-wrap">
                                        <h5 className="mb-0 fw-semibold">{idx.amount}</h5>
                                        <span className={`badge bg-${idx.color}-transparent rounded-pill ms-1`}>{idx.percent}</span>
                                    </div>
                                </div>
                            </Card.Body>
                        </Card>
                    ...
                    <Card className="custom-card">
                        ...
                        <Card.Body>
                            <ul className="list-unstyled timeline-widget mb-0 my-3">
                                <li className="timeline-widget-list mb-3">
                                    <div className="d-flex align-items-top">
                                        ...
                                        <div className="d-flex flex-wrap flex-fill align-items-center justify-content-between">
                                            ...
                                            <Dropdown className="">
                                                <Dropdown.Toggle as="a" href="#!" className="p-2 fs-16 text-muted no-caret" data-bs-toggle="dropdown">
                                ...
                                <Table className="table table-bordered table-hover text-nowrap">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar variant='primary' className="progress progress-xs" now={34} />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td>
                                                <ProgressBar variant='primary' className="progress progress-xs" now={58} />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar variant='primary' className="progress progress-xs" now={62} />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar variant='primary' className="progress progress-xs" now={71} />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar variant='primary' className="progress progress-xs" now={48} />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar variant='primary' className="progress progress-xs" now={28} />
                        ...
                        <Card.Header className="justify-content-between">
                            ...
                            <Dropdown className="">
                                ...
                                <Dropdown.Menu className="dropdown-menu" role="menu">
                                    <Dropdown.Item><Link className="" href="#!">Download</Link></Dropdown.Item>
                                    <Dropdown.Item><Link className="" href="#!">Import</Link></Dropdown.Item>
                                    <Dropdown.Item><Link className="" href="#!">Export</Link></Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </Card.Header>
                        <Card.Body>
                                ...
                                <Table className="table text-nowrap table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar animated variant='primary' className="progress progress-xs" now={60} />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar className="progress progress-xs" striped animated now={0} role="progressbar" aria-valuenow={0} aria-valuemin={0} aria-valuemax={100} />
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar animated variant='primary' className="progress progress-xs" now={100} />
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ProgressBar animated variant='primary' className="progress progress-xs" now={50} />
                    ...
                    <Card className="custom-card">
                        <div className="card-header">
                            ...
                            <Dropdown className="ms-auto">
                                <Dropdown.Toggle as="a" href="#!" className="btn btn-sm btn-primary-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                    Details
                                </Dropdown.Toggle>
