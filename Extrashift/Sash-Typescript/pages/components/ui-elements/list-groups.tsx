...
const ListGroups = () => {
	...
	return (
		...
		<Fragment >
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Basic List"  customCardBodyClass="" code={Listgroup1}>
						<ListGroup as="ul">
				...
				<Col xl={4}>
					<ShowCode title="Active items"  customCardBodyClass="" code={Listgroup2}>
						<ListGroup as="ul">
									...
									<div className="d-flex align-items-center">
										<div>
											<span className="avatar avatar-sm bg-white text-default avatar-rounded ">
												<i className={`bi bi-${idx.class} fs-14`}></i>
											</span>
										</div>
										<div className="ms-2">
											{idx.text}
				...
				<Col xl={4}>
					<ShowCode title="Disabled items"  customCardBodyClass="" code={Listgroup3}>
						<ListGroup as="ul">
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Flush"  customCardBodyClass="" code={Listgroup4}>
				...
				<Col xl={4}>
					<ShowCode title="Links"  customCardBodyClass="" code={Listgroup5}>
				...
				<Col xl={4}>
					<ShowCode title="buttons"  customCardBodyClass="" code={Listgroup6}>
						<ListGroup className="list-group">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Contextual classes"  customCardBodyClass="" code={Listgroup7}>
						<ListGroup as="ul">
				...
				<Col xl={6}>
					<ShowCode title="Contextual classes with hover styles"  customCardBodyClass="" code={Listgroup8}>
						<ListGroup>
							{ContextualButtons.map((idx) => (
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Solid Colored Lists"  customCardBodyClass="" code={Listgroup9}>
						<ListGroup as="ul">
							{ContextualButtons.map((idx) => (
				...
				<Col xl={6}>
					<ShowCode title="Custom content"  customCardBodyClass="" code={Listgroup10}>
						<ListGroup className="list-group">
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Sub headings"  customCardBodyClass="" code={Listgroup11}>
				...
				<Col xl={4}>
					<ShowCode title="Numbered Lists"  customCardBodyClass="" code={Listgroup12}>
						<ListGroup as="ol" numbered>
							<ListGroup.Item as="li">Simply dummy text of the printing.</ListGroup.Item>
							<ListGroup.Item as="li">There are many variations of passages.</ListGroup.Item>
							<ListGroup.Item as="li">All the Lorem Ipsum generators.</ListGroup.Item>
				...
				<Col xl={4}>
					<ShowCode title="List With Checkboxes"  customCardBodyClass="" code={Listgroup13}>
						<ListGroup as="ul">
							<ListGroup.Item as="li">
								<Form.Check className="me-2 fw-semibold" type="checkbox" value=""
				...
				<Col xl={4}>
					<ShowCode title="List With Radios"  customCardBodyClass="" code={Listgroup14}>
						<ListGroup className="list-group">
							<ListGroup.Item className="list-group-item">
								<Form.Check className="me-1" type="radio" value=""
				...
				<Col xl={4}>
					<ShowCode title="List With badges"  customCardBodyClass="" code={Listgroup15}>
						<ListGroup as="ul">
				...
				<Col xl={4}>
					<ShowCode title="Horizontal"  customCardBodyClass="" code={Listgroup16}>
