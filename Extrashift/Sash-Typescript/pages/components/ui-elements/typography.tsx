...
const Typography = () => {
	...
	return (
		<Fragment>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Headings H tags"  customCardBodyClass="" code={typography1}>
					...
					<ShowCode title="Heading Class Names"  customCardBodyClass="" code={typography2}>
				...
				<Col xl={6}>
					<ShowCode title="Display headings"  customCardBodyClass="" code={typography3}>
					...
					<ShowCode title="Customizing headings"  customCardBodyClass="" code={typography4}>
						<h3>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Inline text elements"  customCardBodyClass="" code={typography5}>
				...
				<Col xl={6}>
					<ShowCode title="Font Sizes"  customCardBodyClass="" code={typography6}>
			...
			<Row>
				<Col xl={12} className="">
					<ShowCode title="Lead Paragraph"  customCardBodyClass="" code={typography7}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Description list alignment"  customCardBodyClass="" code={typography8}>
				...
				<Col xl={6}>
					<ShowCode title="List Unstyled"  customCardBodyClass="" code={typography9}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Left Aligned"  customCardBodyClass="" code={typography10}>
				...
				<Col xl={6}>
					<ShowCode title="Right Aligned"  customCardBodyClass="" code={typography11}>
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Primary Blockquote"  customCardBodyClass="" code={typography12}>
				...
				<Col xl={4}>
					<ShowCode title="Secondary Blockquote"  customCardBodyClass="" code={typography13}>
				...
				<Col xl={4}>
					<ShowCode title="Warning Blockquote"  customCardBodyClass="" code={typography14}>
				...
				<Col xl={4}>
					<ShowCode title="Success Blockquote"  customCardBodyClass="" code={typography15}>
				...
				<Col xl={4}>
					<ShowCode title="Info Blockquote"  customCardBodyClass="" code={typography16}>
				...
				<Col xl={4}>
					<ShowCode title="Danger Blockquote"  customCardBodyClass="" code={typography17}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Abbreviations"  customCardBodyClass="" code={typography18}>
						<p><abbr title="attribute">attr</abbr></p>
						<p className="mb-0"><abbr title="HyperText Markup Language" className="initialism">HTML</abbr></p>
					</ShowCode>
					<ShowCode title="List inline"  customCardBodyClass="" code={typography19}>
				...
				<Col xl={6}>
					<ShowCode title="Horizontal rules"  customCardBodyClass="" code={typography20}>
			...
			<Row>
				<Col xl={3}>
					<ShowCode title="Monospace"  customCardBodyClass="" code={typography21}>
						<p className="font-monospace mb-0">This is in monospace</p>
					</ShowCode>
				</Col>
				<Col xl={3}>
					<ShowCode title="Reset color"  customCardBodyClass="" code={typography22}>
				...
				<Col xl={3}>
					<ShowCode title="Visible text"  customCardBodyClass="" code={typography23}>
						<p className="visible mb-0">This is visible text</p>
					</ShowCode>
				</Col>
				<Col xl={3}>
					<ShowCode title="Invisible text"  customCardBodyClass="" code={typography24}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Text transform"  customCardBodyClass="" code={typography25}>
				...
				<Col xl={6}>
					<ShowCode title="Text decoration"  customCardBodyClass="" code={typography26}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Font weight and italics"  customCardBodyClass="" code={typography27}>
				...
				<Col xl={6}>
					<ShowCode title="Line height"  customCardBodyClass="" code={typography28}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Text alignment"  customCardBodyClass="" code={typography29}>
				...
				<Col xl={6}>
					<ShowCode title="Text wrapping and overflow"  customCardBodyClass="" code={typography30}>
					...
					<ShowCode title="Word break"  customCardBodyClass="" code={typography31}>
