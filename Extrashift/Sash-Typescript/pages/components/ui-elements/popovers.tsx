...
import { popovers1, popovers2, popovers3, popovers4, popovers5, popovers6, popovers7, popovers8 } from '@/shared/data/prismdata/uielements-prism';
import { Colorheaderalerts, Colredalerts, Defaultalerts, Dismissiblealerts } from '@/shared/data/ui-elements/popoversdata';
...
const Popovers = () => {
	...
	return (
		<Fragment>
			...
			<Row>
				<Col xl={5}>
					<ShowCode title="Default Popovers"  customCardBodyClass="" code={popovers1}>
				...
				<Col xl={7}>
				<ShowCode title="Colored Headers"  customCardBodyClass="" code={popovers2}>
							<div className="btn-list">
			...
			<Row>
				<Col xl={12} className="">
					<ShowCode title="Colored Popovers"  customCardBodyClass="" code={popovers3}>
						<div className="btn-list">
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Light Popovers"  customCardBodyClass="" code={popovers4}>
						<div className="btn-list">
							{Colredalerts.map((idx: any) => (
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Dismissible Popovers"  customCardBodyClass="d-sm-flex justify-content-lg-between gap-2 flex-wrap card-body" code={popovers5}>
				...
				<Col xl={3}>
					<ShowCode title="Disabled Popover"  customCardBodyClass="" code={popovers6}>
				...
				<Col xl={3}>
					<ShowCode title="Icon Popovers"  customCardBodyClass="" code={popovers7}>
						...
						<OverlayTrigger placement='left' trigger="click" overlay={<Popover className='popover-info only-body' id="tooltip-disabled">
							<Popover.Body>This popover is used to provide details about this icon.</Popover.Body>
						</Popover>}>
							<Link className="me-4" href="#!" >
