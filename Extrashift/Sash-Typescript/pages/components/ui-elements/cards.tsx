import { Backgroundcards, Gridcards, Gridmarkupcards, Mountaincards } from '@/shared/data/ui-elements/cardsdata';
			...
			<Row>
				...
				<Col xxl={3} xl={6} lg={6} md={6} sm={12}>
					...
					<Card className="custom-card">
						...
						<Card.Footer>
							<Link href="#!" className="card-link text-danger">Buy Now</Link>
							<Link href="#!" className="card-link text-success d-inline-flex"><u>Review</u></Link>
						</Card.Footer>
					</Card>
				</Col>
				<Col xxl={3} xl={6} lg={6} md={6} sm={12}>
					<Card className="custom-card">
						<img src="../../../assets/images/media/media-16.jpg" className="card-img-top" alt="..." />
						<Card.Body>
						...
						<Card.Header>
							<div className="d-flex align-items-center w-100">
								...
								<Dropdown className="dropdown ms-auto">
									<Dropdown.Toggle variant='' aria-label="anchor" href="#!" className="btn btn-sm btn-light no-caret" data-bs-toggle="dropdown">
				...
				{Mountaincards.map((idx) => (
					<Col xl={2} key={Math.random()}>
						<Card className="custom-card">
							<Card.Body>
								<img src={idx.src} className="card-img mb-3" alt="..." />
								<h6 className="card-title fw-semibold mb-3">{idx.text1}<Badge bg={idx.color} className={` float-end fs-10 ${idx.class}`}>{idx.text2}</Badge></h6>
								<p className="card-text">With supporting text below as a natural
									lead-in.</p>
							</Card.Body>
						</Card>
				...
				<Col md={4}>
					<Card className="custom-card">
						<Card.Header className="card-header justify-content-between">
							...
							<Link aria-label="anchor" href="#!" onClick={BasicHandleExpandClick}>
				...
				<Col md={4}>
					<Card className="custom-card">
						<Card.Header className="justify-content-between">
							...
							<Modal show={fullscreenshow} fullscreen={fullScreen} onHide={() => setfullscreenShow(false)} className='p-0'>
								<Modal.Header>
									<Modal.Title className="fs-15 mb-0">Fullscreen Button</Modal.Title>
							...
							<Card.Body>
								<div className="d-flex align-items-center w-100">
									...
									<div className="ms-auto">
										<Link href="#!" className={`text-${idx.class}`}><i className="bi bi-three-dots-vertical"></i></Link>
									</div>
								</div>
							</Card.Body>
						</Card>
					...
					<div className="card border border-primary custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">Home Page Design
								<Link aria-label="anchor" href="#!"><i className="bi bi-plus-square float-end text-primary fs-18"></i></Link>
							</p>
					...
					<div className="card border border-secondary custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">Landing Page Design
								<Link aria-label="anchor" href="#!"><i className="bi bi-plus-square float-end text-secondary fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
					...
					<div className="card border border-warning custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">Update New Project
								<Link aria-label="anchor" href="#!"><i className="bi bi-plus-square float-end text-warning fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
					...
					<div className="card border border-info custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">New Project Discussion
								<Link aria-label="anchor" href="#!"><i className="bi bi-plus-square float-end text-info fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
								<span className="badge bg-info-transparent">React</span>
					...
					<div className="card border border-danger custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">Recent Projects Testing
								<Link aria-label="anchor" href="#!"><i className="bi bi-plus-square float-end text-danger fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
					...
					<div className="card border border-success custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">About Us Page redesign
								<Link aria-label="anchor" href="#!"><i className="bi bi-plus-square float-end text-success fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
					...
					<div className="card border border-light custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">New Employees
								<Link aria-label="anchor" href="#!"><i className="bi bi-plus-square float-end text-default fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
								<span className="badge bg-warning-transparent">Html</span>
					...
					<div className="card border border-dark custom-card">
						<Card.Body>
							<p className="fs-14 fw-semibold mb-2 lh-1">Terminated Employees
								<Link aria-label="anchor" href="#!"><i className="bi bi-plus-square float-end text-dark fs-18"></i></Link>
							</p>
							<div className="d-flex flex-wrap gap-2 mb-4">
