...
const Toasts = () => {
	...
	return (
		...
		<Fragment >
			<Seo title="Toast" />
			<Pageheader title="Toast" heading="Ui Elements" active="Toast" />
			<Row>
				<Col xl={4}>
					<ShowCode title="Live example"  customCardBodyClass="" code={toast4}>
						...
						<ToastContainer className="toast-container position-fixed top-0 end-0 p-3">
							<Toast id="liveToast" className="toast fade show" role="alert" aria-live="assertive" aria-atomic="true" onClose={() => setShow(false)} show={show} delay={3000} autohide>
								<Toast.Header className="text-default">
									...
									<strong className="me-auto">Sash</strong> <small>11 mins ago</small>
								</Toast.Header>
					...
					<ShowCode title=" Color schemes"  customCardBodyClass="" code={toast5}>
				...
				<Col xl={4}>
					<ShowCode title="Basic example"  customCardBodyClass="" code={toast6}>
					...
					<ShowCode title="Stacking"  customCardBodyClass="" code={toast7}>
				...
				<Col xl={4}>
					<ShowCode title="Translucent"  customCardBodyClass="" code={toast8}>
					...
					<ShowCode title="Custom content"  customCardBodyClass="" code={toast9}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Color Variants Live"  customCardBodyClass="" code={toast2}>
				...
				<Col xl={6}>
					<ShowCode title="Solid Background Toasts"  customCardBodyClass="" code={toast3}>
						<div className="btn-list">
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Toast Placements"  customCardBodyClass="" code={toast1}>
						<div className="btn-list">
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Aligning Toast Using Flexbox"  customCardBodyClass="" code={toast10}>
