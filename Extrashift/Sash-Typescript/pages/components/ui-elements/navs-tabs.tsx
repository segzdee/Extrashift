			...
			<Row>
				<Col xl={6}>
					<Card className="custom-card">
						...
						<Card.Body>
							<Nav className="nav nav-tabs border-bottom-0" as="ul">
								<Nav.Item as="li">
			...
			<Row>
				<Col xl={6}>
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container defaultActiveKey="first">
								<Nav className="nav nav-tabs mb-3 border-bottom-0" id="myTab" role="tablist" defaultActiveKey="first">
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container id="left-tabs-example" defaultActiveKey="first">
								<Row className="">
									<Col xl={3}>
										<Nav className="nav nav-tabs flex-column nav-style-4 mb-3 mb-xl-0" role="tablist" defaultActiveKey="first">
											<Nav.Item>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<Tab.Container id="left-tabs-example" defaultActiveKey="third">
								<Row className="">
									<Col xl={3}>
										<Nav className="nav nav-tabs flex-column nav-style-5 mb-3 mb-xl-0" role="tablist" defaultActiveKey="third">
											<Nav.Item>
											...
											<table className="table mb-0">
												...
												<tbody>
													<tr>
														<th scope="row">
															<span className="avatar avatar-sm">
																<img src="../../../assets/images/ecommerce/orders/6.jpg" alt="img" />
															</span>
														</th>
														<td>Stop Watch</td>
														<td>Clocks</td>
													...
													<tr>
														<th scope="row">
															<span className="avatar avatar-sm">
																<img src="../../../assets/images/ecommerce/orders/2.jpg" alt="img" />
															</span>
														</th>
														<td>Shoes</td>
														<td>Footwear</td>
