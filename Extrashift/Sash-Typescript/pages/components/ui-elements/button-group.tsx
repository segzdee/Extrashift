...
const Buttongroup = () => {
	return (
		<Fragment>
			...
			<Row>
				<Col xl={3}>
					<ShowCode title="Basic example"  customCardBodyClass="" code={btngroup1}>
				...
				<Col xl={3}>
					<ShowCode title="Navigation"  customCardBodyClass="" code={btngroup2}>
				...
				<Col xl={3}>
					<ShowCode title="Mixed Style"  customCardBodyClass="" code={btngroup3}>
				...
				<Col xl={3}>
					<ShowCode title="Outline styled"  customCardBodyClass="" code={btngroup4}>
				...
				<Col xl={6}>
					<ShowCode title="Checkbox button groups"  customCardBodyClass="" code={btngroup5}>
				...
				<Col xl={6}>
					<ShowCode title=" Radio button groups"  customCardBodyClass="" code={btngroup6}>
				...
				<Col xl={6}>
					<Row>
						<Col xl={12}>
							<ShowCode title="Sizing"  customCardBodyClass="" code={btngroup7}>
						...
						<Col xl={12}>
							<ShowCode title="Button toolbar"  customCardBodyClass="" code={btngroup8}>
						...
						<Col xl={12}>
							<ShowCode title="Nesting"  customCardBodyClass="" code={btngroup9}>
								<ButtonGroup className="btn-group" role="group"
									...
									<DropdownButton align="end" as={ButtonGroup} title="Dropdown" id="bg-nested-dropdown">
				...
				<Col xl={6}>
					<Row>
						<Col xl={12}>
							<ShowCode title="Vertical variation"  customCardBodyClass="" code={btngroup10}>
						...
						<Col xl={12}>
							<ShowCode title="Social Group Buttons"  customCardBodyClass="" code={btngroup11}>
								<ButtonGroup className="btn-group" role="group" aria-label="Basic example">
									{SocialIconButtons.map((idx) => (
										<Button variant={idx.class} className="btn btn-icon btn-wave" key={Math.random()}>
											<i className={`ri-${idx.class1}-line`}></i>
										</Button>
									))}
								</ButtonGroup>
							</ShowCode>
