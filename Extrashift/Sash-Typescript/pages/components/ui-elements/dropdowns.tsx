...
import { ButtonGroup, Col, Dropdown, DropdownButton, Form, Row, SplitButton, Button } from 'react-bootstrap';
...
const DropDowns = () => {
	...
	return (
		<div >
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Dropdowns"  customCardBodyClass="" code={dropdown1}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Single dropdown buttons"  customCardBodyClass="" code={dropdown2}>
				...
				<Col xl={6}>
					<ShowCode title="Rounded Button Dropdowns"  customCardBodyClass="" code={dropdown3}>
						<div className="btn-list">
							{SingleButtons.map((idx) => (
								<div className="btn-group" key={Math.random()}>
									<Dropdown>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Outline Button Dropdowns"  customCardBodyClass="" code={dropdown4}>
						<div className="btn-list">
				...
				<Col xl={6}>
					<ShowCode title="Rounded Outline Dropdowns"  customCardBodyClass="" code={dropdown5}>
						<div className="btn-list">
							{OutlineButtons.map((idx) => (
								<div className="btn-group me-0" key={Math.random()}>
									<Dropdown>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Split buttons"  customCardBodyClass="" code={dropdown6}>
				...
				<Col xl={6}>
					<ShowCode title="Dropdown Sizing"  customCardBodyClass="" code={dropdown7}>
			...
			<Row>
				<Col xl={3}>
					<ShowCode title="Dropup"  customCardBodyClass="" code={dropdown8}>
				...
				<Col xl={3}>
					<ShowCode title="Dropup right"  customCardBodyClass="" code={dropdown9}>
				...
				<Col xl={3}>
					<ShowCode title="Dropup left"  customCardBodyClass="" code={dropdown10}>
				...
				<Col xl={3}>
					<ShowCode title="Active"  customCardBodyClass="" code={dropdown11}>
						<Dropdown>
							<Dropdown.Toggle variant='' type="button" className="btn btn-primary dropdown-toggle"
								data-bs-toggle="dropdown" aria-expanded="false">
								Dropstart
			...
			<Row>
				<Col xl={3}>
					<ShowCode title="Disabled"  customCardBodyClass="" code={dropdown12}>
						<Dropdown>
							<Dropdown.Toggle variant='' type="button" className="btn btn-primary dropdown-toggle"
								data-bs-toggle="dropdown" aria-expanded="false">
								Dropstart
				...
				<Col xl={6}>
					<ShowCode title="Auto close behavior"  customCardBodyClass="" code={dropdown13}>
						<div className="btn-list">
				...
				<Col xl={3}>
					<ShowCode title="dropdowns with Forms"  customCardBodyClass="" code={dropdown14}>
						<Dropdown>
								...
								<Form className="px-4 py-3">
									...
									<div className="mb-3">
										<div className="form-check">
											<Form.Check type="checkbox" className="" id="dropdownCheck" />
											<Form.Label className="" htmlFor="dropdownCheck">
												Remember me
											</Form.Label>
										</div>
									</div>
			...
			<Row>
				<Col xxl={3} xl={6}>
					<ShowCode title="Dropdown menu centered"  customCardBodyClass="" code={dropdown15}>
				...
				<Col xxl={3} xl={6}>
					<ShowCode title="Dropup centered"  customCardBodyClass="" code={dropdown16}>
				...
				<Col xxl={3} xl={6}>
					<ShowCode title="Menu items"  customCardBodyClass="" code={dropdown17}>
				...
				<Col xxl={3} xl={6}>
					<ShowCode title="Dropdowns options"  customCardBodyClass="" code={dropdown18}>
			...
			<Row>
				<Col xl={9}>
					<ShowCode title="Alignment options"  customCardBodyClass="" code={dropdown19}>
						<div className="btn-list">
							{AlignmentButtons.map((idx: any) => (
								<div className="btn-group" key={Math.random()}>
									<Dropdown drop={idx.dir}>
										...
										<Dropdown.Menu as="ul" className='dropdown-menu-end' align="start">
											<Dropdown.Item as="li" href="#!">Menu item</Dropdown.Item>
											<Dropdown.Item as="li" href="#!">Menu item</Dropdown.Item>
											<Dropdown.Item as="li" href="#!">Menu item</Dropdown.Item>
										</Dropdown.Menu>
				...
				<Col xl={3}>
					<ShowCode title="Dark Dropdowns"  customCardBodyClass="" code={dropdown20}>
						<Dropdown>
							<Dropdown.Toggle variant='' className="btn btn-dark dropdown-toggle" type="button"
								id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
								Dropdown button
							</Dropdown.Toggle>
							<Dropdown.Menu as="ul" className="dropdown-menu-dark">
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Menu alignment"  customCardBodyClass="" code={dropdown21}>
						<Dropdown>
							<Dropdown.Toggle variant='' type="button" className="btn btn-primary dropdown-toggle"
								data-bs-toggle="dropdown" aria-expanded="false">
				...
				<Col xl={4}>
					<ShowCode title="Responsive alignment end"  customCardBodyClass="" code={dropdown22}>
						<div className="btn-group">
				...
				<Col xl={4}>
					<ShowCode title="Responsive alignment left"  customCardBodyClass="" code={dropdown23}>
						<div className="btn-group">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Custom Dropdown Menu's"  customCardBodyClass="" code={dropdown24}>
						<div className="btn-list">
				...
				<Col xl={6}>
					<ShowCode title="Ghost Button Dropdowns"  customCardBodyClass="" code={dropdown25}>
						<div className="btn-list">
			...
			<Row>
				<Col xl={3}>
					<ShowCode title="non-interactive dropdown items"  customCardBodyClass="" code={dropdown26}>
				...
				<Col xl={3}>
					<ShowCode title="Dropdown Headers"  customCardBodyClass="" code={dropdown27}>
				...
				<Col xl={3}>
					<ShowCode title="Dropdown Dividers"  customCardBodyClass="" code={dropdown28}>
						<div className="bd-example">
							<Dropdown.Menu className="dropdown-menu" show>
				...
				<Col xl={3}>
					<ShowCode title="Dropdown Menu Text"  customCardBodyClass="" code={dropdown29}>
						<div className="bd-example">
