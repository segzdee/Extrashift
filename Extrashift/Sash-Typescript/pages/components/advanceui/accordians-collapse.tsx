...
const Accordianscollapse = () => {
	...
	return (
		<Fragment>
			<Seo title={"Accordian-Collapse"} />
			<Pageheader title="Accordians Collapse" heading="Advanced Ui" active="Accordians Collapse" />
			<Row>
				<Col xl={6}>
					<ShowCode title="Basic Accordion"  customCardBodyClass="" code={accordion1}>
				...
				<Col xl={6}>
					<ShowCode title="Always Open Accordion <p class='text-muted subtitle fs-12 fw-normal'>Omit the <code>data-bs-parent</code> attribute on each
								...
								</p>"  customCardBodyClass="" code={accordion2}>
			...
			<Row>
				<Col xl={12}>
                  ...
                  their
                  parent container.
								</p>"  customCardBodyClass="p-0" code={accordion3}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Primary"  customCardBodyClass="" code={accordion6}>
				...
				<Col xl={6}>
					<ShowCode title="Secondary"  customCardBodyClass="" code={accordion7}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Primary"  customCardBodyClass="" code={accordion4}>
				...
				<Col xl={6}>
					<ShowCode title="Secondary"  customCardBodyClass="" code={accordion5}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Primary"  customCardBodyClass="" code={accordion10}>
				...
				<Col xl={6}>
					<ShowCode title="Success"  customCardBodyClass="" code={accordion11}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Left Aligned Icons"  customCardBodyClass="" code={accordion12}>
				...
				<Col xl={6}>
					<ShowCode title="Without Icon"  customCardBodyClass="" code={accordion13}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Custom Icon Accordion"  customCardBodyClass="" code={accordion8}>
				...
				<Col xl={6}>
					<ShowCode title="Custom Accordion"  customCardBodyClass="" code={accordion9}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Example"  customCardBodyClass="" code={accordion14}>
						<p className="mb-0">
						...
						<Collapse in={openb}>
							<div className="card card-body mb-0 border">
				...
				<Col xl={6}>
					<ShowCode title="Multiple Targets Collapse"  customCardBodyClass="" code={accordion15}>
						<p className="mb-0">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Horizontal Collapse"  customCardBodyClass="" code={accordion16}>
						<p>
						...
						<div style={{ minHeight: "120px" }}>
							<Collapse in={open} dimension="width">
								<div id="example-collapse-text">
									<Card className="border" body style={{ width: "230px" }}>This is some placeholder content for a horizontal collapse. It's
...
Accordianscollapse.layout = "Contentlayout"
