...
const Modalscloses = () => {
	...
	return (
		<Fragment>
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Basic Modal"  customCardHeaderClass="" customCardBodyClass="" code={modal1}>
				...
				<Col xl={4}>
					<ShowCode title="Static backdrop"  customCardHeaderClass="" customCardBodyClass="" code={modal2}>
				...
				<Col xl={4}>
					<ShowCode title="Scrolling long content"  customCardHeaderClass="" customCardBodyClass="" code={modal3}>
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Vertically centered modal"  customCardHeaderClass="" customCardBodyClass="" code={modal4}>
				...
				<Col xl={4}>
					<ShowCode title="Vertical Centered Scrollable"  customCardHeaderClass="" customCardBodyClass="" code={modal5}>
				...
				<Col xl={4}>
					<ShowCode title="Tooltips"  customCardHeaderClass="" customCardBodyClass="" code={modal6}>
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Using the grid"  customCardHeaderClass="" customCardBodyClass="" code={modal7}>
				...
				<Col xl={4}>
					<ShowCode title="Toggle between modals"  customCardHeaderClass="" customCardBodyClass="" code={modal8}>
				...
				<Col xl={4}>
					<ShowCode title="Optional sizes"  customCardHeaderClass="" customCardBodyClass="" code={modal9}>
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Fullscreen modal"  customCardHeaderClass="" customCardBodyClass="" code={modal10}>
						{values.map((v, idx) => (
							<Button variant=""
								key={idx}
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Varying modal content"  customCardHeaderClass="" customCardBodyClass="" code={modal11}>
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Basic Close"  customCardHeaderClass="" customCardBodyClass="" code={modal12}>
						<Button variant='' type="button" className="btn-close" aria-label="Close"></Button>
					</ShowCode>
				</Col>
				<Col xl={4}>
					<ShowCode title="Disable state"  customCardHeaderClass="" customCardBodyClass="" code={modal13}>
