...
import { Landingdata } from '@/shared/data/pages/landingdata';
...
const Landing = ({ ThemeChanger }: any) => {
    ...
    useEffect(() => {
        function handleScroll() {
            ...
            const cardRevealPoint = 150;
            const reveals = document.querySelectorAll('.reveal');
            reveals.forEach((reveal: any) => {
                const cardTop = reveal.getBoundingClientRect().top;
                    ...
                    <header className="app-header">
                        <div className="main-header-container container-fluid">
                            <div className="header-content-left">
                                ...
                                <div className="header-element">
                                    <Link aria-label="anchor" href="#!" className="sidemenu-toggle header-link" data-bs-toggle="sidebar">
                            ...
                            <div className="header-content-right">
                                <div className="header-element align-items-center">
                                    <div className="btn-list d-lg-none d-flex">
                                        <Link href="/components/authentication/signup" className="btn btn-sm-w-sm btn-wave btn-outline-primary"> New User </Link>
                                        <Link href="/components/authentication/signin" className="btn btn-sm-w-sm btn-wave btn-primary"> Log In </Link>
                                        <div className="switcher-icon nav-link icon" data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas" onClick={() => Switchericon()}>
                                ...
                                <nav className="main-menu-container nav nav-pills sub-open">
                                    ...
                                    <div className="d-lg-flex d-none">
                                        <div className="btn-list d-lg-flex d-none mt-lg-2 mt-xl-0 mt-0">
                                            <Link href="/components/authentication/signup" className="btn btn-w-sm btn-wave btn-outline-primary">
                                                New User
                                            </Link>
                                            <Link href="/components/authentication/signin" className="btn btn-w-sm btn-wave btn-primary">
                                                Log In
                                            </Link>
                                            <div className="switcher-icon nav-link icon" data-bs-toggle="offcanvas" data-bs-target="#switcher-canvas" onClick={() => Switchericon()}>
                                                <i className="fe fe-settings fa-spin  text_primary"></i>
                    ...
                    <div className="main-content landing-main" onClick={handleClick}>
                        <div className="landing-banner" id="home">
                            <section className="section">
                                <div className="container px-sm-0 main-banner-container pb-0">
                                    <div className="row">
                                        <Col xl={6} lg={6} className="animation-zidex pos-relative my-auto">
                                            <h5 className="fw-semibold">Manage Your Business</h5>
                                            <h1 className="text-start fw-bold mb-3 lh-base">We Help to Build Your Dream Project with <span className="text-primary animate-heading">Sash</span></h1>
                                            <p className="pb-3 mb-3">
                                                ...
                                                but by using this Sash-Admin template.</p>

                                            <Link href="/components/dashboard/dashboard" target="_blank" className="btn ripple btn-min w-lg me-2 btn-primary"><i className="fe fe-play me-2"></i> Get Started
                                            </Link>
                                            <Link href="https://themeforest.net/user/spruko/portfolio" className="btn ripple btn-min w-lg btn-outline-primary me-2" target="_blank"><i className="fe fe-eye me-2 d-inline-flex"></i>Discover More
                                            </Link>
                                        </Col>
                                        <div className="col-xl-6 col-lg-6 my-auto text-end">
                                            <img src="../../../assets/images/landing/2.png" alt="" className="w-100" />
                                        </div>
                                    </div>
                                </div>
                            </section>
                        ...
                        <section className="section section-bg" id="about">
                            <div className="container text-center">
                                <p className="fs-18 fw-medium mb-1"><span className="landing-section-heading">About</span></p>
                                <span className="landing-title"></span>
                                <h3 className="fw-semibold mb-5">Designed with precision and well documented</h3>
                            </div>
                            <div className="row justify-content-center align-items-center g-0">
                                <div className="col-xxl-5 col-xl-5 col-lg-5 customize-image text-center">
                                    <div className="text-lg-end">
                                        <img src="../../../assets/images/landing/1.png" alt="" className="img-fluid" />
                                    </div>
                                </div>
                                <Col xxl={5} xl={5} lg={5} className="my-auto text-start pt-5 pb-0 px-lg-2 px-5">
                        ...
                        <section className="section" id="statistics">
                            <div className="container text-center position-relative">
                                <p className="fs-18 fw-medium mb-1"><span className="landing-section-heading">Statistics</span></p>
                                <span className="landing-title"></span>
                                <h3 className="fw-semibold mb-5">Sash Template Statistics.</h3>
                                <div className="row justify-content-evenly">
                                    <Col xl={3} md={6} lg={6} className="">
                                        <div className="card bg-primary-transparent">
                                            <div className="card-body">
                                                <div className="counter-icon icon-1">
                                                    <i className="fe fe-layers"></i>
                                                </div>
                                                <h2 className="mb-0 text-dark fw-semibold"><span className="counter">100</span>+</h2>
                                                <h6 className="fw-normal mb-0 text-dark">HTML Pages</h6>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col xl={3} md={6} lg={6} className="">
                                        <div className="card bg-secondary-transparent">
                                            <div className="card-body">
                                                <div className="counter-icon icon-2">
                                                    <i className="fe fe-wind"></i>
                                                </div>
                                                <h2 className="mb-0 text-dark fw-semibold"><span className="counter">60</span>+</h2>
                                                <h6 className="fw-normal mb-0 text-dark">Integrated Plugins</h6>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col xl={3} md={6} lg={6} className="">
                                        <div className="card bg-success-transparent">
                                            <div className="card-body">
                                                <div className="counter-icon icon-3">
                                                    <i className="fe fe-file-text"></i>
                                                </div>
                                                <h2 className="mb-0 text-dark fw-semibold"><span className="counter">10</span>+</h2>
                                                <h6 className="fw-normal mb-0 text-dark">Form Elements</h6>
                                            </div>
                                        </div>
                                    </Col>
                                    <Col xl={3} md={6} lg={6} className="">
                                        <div className="card bg-danger-transparent">
                                            <div className="card-body">
                                                <div className="counter-icon icon-4">
                                                    <i className="fe fe-grid"></i>
                                                </div>
                                                <h2 className="mb-0 text-dark fw-semibold"><span className="counter">30</span>+</h2>
                                                <h6 className="fw-normal mb-0 text-dark">Customize Widgets</h6>
                                            </div>
                                        </div>
                                    </Col>
                                </div>
                        ...
                        <section className="section section-bg " id="our-mission">
                            <div className="container text-center">
                                <p className="fs-18 fw-medium mb-1"><span className="landing-section-heading">OUR MISSION</span></p>
                                <span className="landing-title"></span>
                                <h2 className="fw-semibold mb-5">Our mission consists of 8 major steps.</h2>
                                <div className="row">
                                    {Landingdata.map((idx) => (
                                        <Col xxl={3} xl={3} md={6} sm={6} className="col-12" key={Math.random()}>
                                            <div className="card  text-start landing-missions">
                                                <div className="card-body">
                                                    <div className="align-items-top">
                                                        <div className="mb-2">
                                                            <span className="avatar avatar-lg avatar-rounded bg-primary-transparent">
                                                                <i className={`bx bx-${idx.icon} fs-25`}></i>
                                                            </span>
                                                        </div>
                                                        <div>
                        ...
                        <section className="section landing-Features" id="features">
                            <div className="container text-center">
                                <p className="fs-18 fw-medium mb-1 text-fixed-white"><span className="landing-section-heading">Features</span></p>
                                <span className="landing-title"></span>
                                <h2 className="fw-semibold mb-3 text-fixed-white">Features Used in Sash Admin Template</h2>
                                <div className="feature-logos mt-sm-5 flex-wrap" >
                                    <Swiper centeredSlides={false} autoplay={{ delay: 2500, disableOnInteraction: false, }} modules={[Autoplay]} breakpoints = {{
                                        320: {
                                          slidesPerView: 2,
                                          spaceBetween: 10,
                                        },
                                        ...
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <img src="../../../assets/images/landing/web/9.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">Nextjs</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <img src="../../../assets/images/landing/web/8.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">React Bootstrap</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <img src="../../../assets/images/landing/web/1.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">Sass</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <img src="../../../assets/images/landing/web/3.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">Yarn</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <img src="../../../assets/images/landing/web/6.png" alt="image" className="featur-icon" />
                                                <h5 className="mt-3 text-fixed-white ">NPM</h5>
                                            </div>
                                        </SwiperSlide>
                                        <SwiperSlide>
                                            <div className="ms-sm-5 ms-2 text-center">
                                                <img src="../../../assets/images/landing/web/5.png" alt="image" className="featur-icon" />
                        ...
                        <section className="section landing-testimonials section-bg" id="testimonials">
                            <div className="container text-center">
                                <p className="fs-18 fw-medium mb-1"><span className="landing-section-heading">Testinominals</span></p>
                                <span className="landing-title"></span>
                                <h3 className="fw-semibold mb-5">We never failed to reach expectations</h3>
                                <Swiper spaceBetween={30} centeredSlides={true} autoplay={{ delay: 2500, disableOnInteraction: false, }} navigation={true} pagination={{ clickable: true }}
                        ...
                        <section className="section" id="pricing">
                            <div className="container text-center">
                                <p className="fs-18 fw-medium mb-1"><span className="landing-section-heading">Pricing</span></p>
                                <span className="landing-title"></span>
                                <h3 className="fw-semibold mb-5">sash comes with most affordable pricing range.</h3>
                                <Tab.Container defaultActiveKey="month">
                                    <div className="d-flex justify-content-center mb-4">
                                        <Nav className="nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab" role="tablist">
                                            <Nav.Item className="" role="presentation">
                                                <Nav.Link className="" id="pricing-monthly" data-bs-toggle="tab" eventKey="month"
                                            ...
                                            <Nav.Item className="" role="presentation">
                                                <Nav.Link className="" id="pricing-yearly" data-bs-toggle="tab" eventKey="year"
                                    ...
                                    <div className="card  border-0 overflow-hidden shadow-none">
                                        <div className="card-body p-0">
                                            <Tab.Content className="" id="myTabContent">
                                                <Tab.Pane eventKey="month" className="p-0" id="pricing-monthly-pane"
                                                        ...
                                                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 border-end border-inline-end-dashed">
                                                            <div className="p-4">
                                                                ...
                                                                <div className="d-grid">
                                                                    <Button variant='' type="button" className="btn btn-primary-light btn-wave">Get Started</Button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 border-end border-inline-end-dashed">
                                                        ...
                                                        <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12">
                                                            <div className="p-4 pricing-offer overflow-hidden">
                                                                ...
                                                                <div className="py-4 d-flex align-items-center justify-content-center">
                                                                    ...
                                                                    <div className="text-end ms-5">
                                                                        <p className="fs-25 fw-semibold mb-0 text-primary">$999</p>
                                                                        <p className="text-muted fs-11 fw-semibold mb-0">per month</p>
                                                                    </div>
                                                                </div>
                                                                <ul className="list-unstyled text-center fs-12 px-3 pt-3 mb-0">
                                                                ...
                                                                <div className="d-grid">
                                                                    <Button variant='' type="button" className="btn btn-primary btn-wave shadow">Get Started</Button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </Tab.Pane>
                                                <Tab.Pane eventKey="year" className="p-0" id="pricing-yearly-pane"
                        ...
                        <section className="section section-bg" id="team">
                            <div className="container text-center">
                                <p className="fs-18 fw-medium mb-1"><span className="landing-section-heading">Our Team</span></p>
                                <span className="landing-title"></span>
                                <h3 className="fw-semibold mb-5">Great things in business are done by a team.</h3>
                                <div className="row">
                                    <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6 col-sm-12">
                                        <div className="card text-center team-card ">
                                            <div className="card-body p-5">
                                                ...
                                                <div className="mt-2">
                                                    <Link href="/components/pages/profile" className="btn btn-light">View profile</Link>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="mt-5">
                                    <Button variant='' type="button" className="btn btn-primary">View All</Button>
                                </div>
                            </div>
                        </section>
                        <section className="section" id="faq">
                            <div className="container text-center">
                                <p className="fs-18 fw-medium mb-1"><span className="landing-section-heading">F.A.Q</span></p>
                                <span className="landing-title"></span>
                                <h3 className="fw-semibold mb-5">Frequently asked questions ?</h3>
                                <div className="row gy-2">
                                    <div className="col-xl-6">
                                        <Accordion className="accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ1" defaultActiveKey="1">
                                    ...
                                    <div className="col-xl-6">
                                        <Accordion className="accordion accordion-customicon1 accordion-primary accordions-items-seperate" id="accordionFAQ2" defaultActiveKey="12">
                        ...
                        <section className="section pb-0" id="contact">
                            <div className="container text-center">
                                <div className="card mb-0">
                                    <div className="mt-5">
                                        <p className="fs-18 fw-medium mb-1"><span className="landing-section-heading text-dark">Contact Us</span></p>
                                        <span className="landing-title"></span>
                                        <h3 className="fw-semibold">Get in Touch with <span className="text-primary">US.</span></h3>
                                    </div>
                                    <div className="card-body text-dark">
                                        <div className="row justify-content-center p-5 pt-0">
                                            <div className="col-lg-9">
                                                <div className="row text-center services-statistics">
                                                    <Col xl={3} md={6} lg={6} className="">
                                                        <div className="card bg-transparent border-0 shadow-none">
                                                            <div className="card-body p-0">
                                                                ...
                                                                <h5 className="mb-2 fw-medium">Main Branch</h5>
                                                    ...
                                                    <Col xl={3} md={6} lg={6} className="">
                                                        <div className="card bg-transparent border-0 shadow-none">
                                                            <div className="card-body p-0">
                                                                ...
                                                                <h5 className="mb-2 fw-medium">Phone &amp; Email</h5>
                                                        ...
                                                        <div className="card bg-transparent border-0 shadow-none">
                                                            <div className="card-body p-0">
                                                                <div className="counter-status">
                                                                    ...
                                                                    <h5 className="mb-2 fw-medium">Working Hours</h5>
                                            ...
                                            <div className="col-xl-9">
                                                <form className="form-horizontal text-start" action="/components/dashboard/dashboard">
                        ...
                        <div className="container">
                            <div className="buynow-landing reveal">
                                <div className="card bg-transparent border-0 shadow-none mb-0">
                                    <div className="card-body p-5">
                                        <div className="row">
                                            <div className="col-lg-9 my-auto">
                                                <h2 className="fw-semibold text-fixed-white">Start Your Project
                                                    with Sash.</h2>
                                                <p className="text-fixed-white mb-0">Sed ut perspiciatis unde omnis
                                            ...
                                            <div className="col-lg-3 text-end my-auto">
                                                <Link href="https://themeforest.net/user/spruko/portfolio" target="_blank" className="btn btn-pink w-lg pt-2 pb-2 d-inline-flex align-items-center"><i className="fe fe-shopping-cart me-2"></i>Buy Now
                                                </Link>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="row">
                                    <div className="col-xl-4">
                                        <div className="px-4">
                                            ...
                                            <p className="mb-5 mb-lg-2 text-muted">Duis aute irure dolor in reprehenderit in voluptate
                                                velit esse cillum dolore eu fugiat nulla pariatur Excepteur sint occaecat .
                                            </p>
                                        </div>
                                    </div>
                                    <div className="col-xl-2">
                                        <div className="px-4 mb-5 mb-lg-0">
                                            <h6 className="fw-semibold mb-3">PAGES</h6>
                                            <ul className="list-unstyled op-6 fw-medium landing-footer-list mb-0">
                                                <li>
                                                ...
                                                <li>
                                                    <Link href="#!" className="">Contacts</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="col-xl-2">
                                        <div className="px-4 mb-5 mb-lg-0">
                                            ...
                                            <ul className="list-unstyled op-6 fw-medium landing-footer-list mb-0">
                                                <li>
                                                    <Link href="#!" className="">Our Team</Link>
                                                </li>
                                                <li>
                                    ...
                                    <div className="col-xl-4">
                                        <div className="px-4">
                                            <Link href="/components/dashboard/dashboard"><img loading="lazy" alt="" className="logo-2 mb-3" src="../../../assets/images/brand-logos/desktop-logo.png" /></Link>
                                            <Link href="/components/dashboard/dashboard"><img src="../../../assets/images/brand-logos/desktop-white.png" className="logo-3 mb-3" alt="logo" /></Link>
                                            ...
                                            <div className="form-group">
                                                <div className="input-group">
                                                    <Form.Control type="text" className="" placeholder="Enter your email" aria-label="Example text with button addon" />
                                                    <Button variant='' className="btn btn-primary" type="button" id="button-addon2">Submit</Button>
                                                </div>
                                            </div>
                                            <div className="btn-list mt-4">
                                                <Button variant='' type="button" className="btn btn-icon rounded-pill"><i className="ri-facebook-line"></i></Button>
                                                <Button variant='' type="button" className="btn btn-icon rounded-pill"><i className="ri-youtube-line"></i></Button>
                                                <Button variant='' type="button" className="btn btn-icon rounded-pill"><i className="ri-twitter-x-line"></i></Button>
                                                <Button variant='' type="button" className="btn btn-icon rounded-pill"><i className="ri-instagram-line"></i></Button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="text-center landing-main-footer py-3">
                            <span className="text-muted fs-15"> Copyright ©
                                <span id="year">2024  </span>
                                <Link href="#!" className="text-primary fw-semibold">sash</Link>.Designed with
                                <span className="fa fa-heart text-danger"></span> by
                                <Link href="#!" className="text-primary fw-semibold"> Spruko</Link> All rights reserved
                            </span>
                        </div>
                    </div>
                </div>
...
Landing.layout = "Landingpagelayout"
