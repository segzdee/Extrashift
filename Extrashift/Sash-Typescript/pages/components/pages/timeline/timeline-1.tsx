...
const Timeline1 = () => {
    return (
        <Fragment>
            <Seo title="Timeline-1" />
            <Pageheader title="Timeline-1" heading="Timeline" active="Timeline-1" />
            <Row className="justify-content-center">
                <Col xxl={9} xl={10} sm={12} className="">
                                        ...
                                        <div className="align-items-center">
                                            <div className="mt-sm-0 mt-2">
                                                ...
                                                <div className="text-center demo-gallery">
                                                    <div className="mt-2">
                                                        <div className="d-flex row row-sm">
                                                            <span className="col-sm-6 col-lg-4 mb-4 mb-lg-2">
                                                                <Link href="#!">
...
Timeline1.layout = "Contentlayout"
