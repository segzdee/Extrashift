...
const Timeline2 = () => {
    return (
        <Fragment>
            <Seo title="Timeline-2" />
            <Pageheader title="Timeline-2" heading="Timeline" active="Timeline-2" />
            <Row className="justify-content-center">
                <Col xxl={8} xl={9} lg={10} md={8} sm={10} className="">
                    <ul className="timeline-center list-unstyled">
                        <li>
                            ...
                            <div className="timeline-center-body">
                                <div className="mt-sm-0 mt-2">
                                    ...
                                    <div className="mt-3 d-sm-flex flex-wrap">
                                        <Link href="#!" className="p-2 rounded-2 d-flex border m-1">
                                        ...
                                        <Link href="#!" className="p-2 rounded-2 d-flex m-1 border">
                                            <div className="attachment-icon me-2">
                                                    ...
                                                    <div className="mt-2">
                                                        <div className="d-flex row row-sm gy-4">
                                                            <span className="col-6 col-lg-4">
                                                                <Link href="#!">
                                                                    <img className="img-responsive br-5 w-100" src="../../../../assets/images/media/media-27.jpg" alt="Thumb-1" />
                                                                </Link>
                                                            </span>
                                                            <span className="col-6 col-lg-4">
                                                                <Link href="#!">
                                                                    <img className="img-responsive br-5 w-100" src="../../../../assets/images/media/media-28.jpg" alt="Thumb-1" />
                                                                </Link>
                                                            </span>
                                                            <span className="col-6 col-lg-4">
                                                                <Link href="#!">
                                                                    <img className="img-responsive br-5 w-100" src="../../../../assets/images/media/media-30.jpg" alt="Thumb-1" />
                                                                </Link>
                                                            </span>
                                                        </div>
                                                    </div>
                                    ...
                                    <div className="flex-fill">
                                        <div className="align-items-center">
                                            ...
                                            <div className="d-flex align-items-end">
                                                <Button variant='light' className="btn btn-sm   mt-2">
                                                    50k &#128150;
                                                </Button>
                                    ...
                                    <div className="flex-fill">
                                        <div className="align-items-center">
                                            <div className="mt-sm-0 mt-2">
                                                ...
                                                <p className="mb-0 text-muted">Social orem ipsum  network accounts are at risk check your <span className="badge bg-success-transparent fw-semibold mx-1">login</span> details Lorem ipsum dolor sit amet consectetur adipisicing elitorem ipsum
                                                    <Link href="#!" className="text-primary ms-2 text-decoration-underline">Read more</Link></p>
                                            </div>
                                            <div className="ms-auto">
                                                <span className="float-end badge bg-light text-muted timeline-badge mt-2  rounded-1">
                                                    10:00 AM
                        ...
                        <li>
                            ...
                            <div className="timeline-center-body">
                                <div className="d-md-flex align-items-top timeline-main-content  mt-0">
                                    ...
                                    <div className="flex-fill">
                                        <div className="align-items-center">
                                            ...
                                            <div className="d-flex align-items-end">
                                                <Button variant='light' className="btn btn-sm   mt-2 me-2">
                                                    73k &#128077;
                                                </Button>
                                                <Button variant='light' className="btn btn-sm   mt-2">
                                                    55 &#128525;
...
Timeline2.layout = "Contentlayout"
