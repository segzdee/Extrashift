...
const Pricing = () => {
    return (
        <Fragment>
            ...
            <Row className=" mb-5">
                <Col xl={12}>
                    <h5 className="fw-semibold text-center mb-0"> Simple Pricing For Everyone </h5>
                    <Tab.Container defaultActiveKey="month">
                        <div className="d-flex justify-content-center mt-4">
                            <Nav className="nav-tabs mb-3 tab-style-6 bg-primary-transparent" role="tablist">
                                <Nav.Item className="">
                                    <Nav.Link eventKey="month" className="" >Monthly</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className="">
                                    <Nav.Link eventKey="year" className="" >Yearly</Nav.Link>
                                </Nav.Item>
                            </Nav>
                        </div>
                        <Tab.Content className="" id="myTabContent1">
                            <Tab.Pane className="p-0 border-0" id="pricing-monthly1-pane" eventKey="month"
                                            ...
                                            <Card.Body className=" p-0">
                                                <div className="p-4">
                                                    ...
                                                    <ul className="list-unstyled mb-0">
                                                        ...
                                                        <li className="d-grid">
                                                            <Button variant='' type="button" className="btn btn-light btn-wave">Choose Plan</Button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </Card.Body>
                                                ...
                                                <Card.Body className=" p-0">
                                                    <div className="p-4">
                                                        ...
                                                        <ul className="list-unstyled mb-0">
                                                            ...
                                                            <li className="d-grid">
                                                                <Button variant='' type="button" className="btn btn-primary btn-wave">Choose Plan</Button>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </Card.Body>
                            ...
                            <Tab.Pane className="p-0 border-0" id="pricing-yearly1-pane" eventKey="year"
                ...
                <Col xl={12}>
                    ...
                    <Tab.Container defaultActiveKey="Month">
                        <div className="d-flex justify-content-center mb-4">
                            <Nav className="nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab1" role="tablist">
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link className="" id="pricing-monthly11" data-bs-toggle="tab" eventKey="Month"
                                        data-bs-target="#pricing-monthly11-pane" type="button" role="tab"
                                        aria-controls="pricing-monthly11-pane" aria-selected="true">Monthly</Nav.Link>
                                </Nav.Item>
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link className="" id="pricing-yearly11" data-bs-toggle="tab" eventKey="Year"
                                        data-bs-target="#pricing-yearly11-pane" type="button" role="tab"
                                        aria-controls="pricing-yearly11-pane" aria-selected="false">Yearly</Nav.Link>
                                </Nav.Item>
                            </Nav>
                        </div>
                        <Tab.Content className="" id="myTabContent11">
                            <Tab.Pane className=" p-0 border-0" id="pricing-monthly11-pane" eventKey="Month"
                                role="tabpanel" aria-labelledby="pricing-monthly11" tabIndex={0}>
                                <Row className="">
                                            ...
                                            <Card.Body className=" p-0">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <ul className="list-unstyled mb-0">
                                                        ...
                                                        <li className="d-grid">
                                                            <Button variant='' className="btn btn-primary btn-wave" type="button">Choose Plan</Button>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </Card.Body>
                            ...
                            <Tab.Pane className="p-0 border-0" id="pricing-yearly11-pane" eventKey="Year"
                                role="tabpanel" aria-labelledby="pricing-yearly11" tabIndex={0}>
                                <Row className="">
                                    <div className="col-xxl-3 col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                        <Card className="custom-card overflow-hidden">
                                            <Card.Body className=" p-0">
                    ...
                    <Tab.Container defaultActiveKey="MONTH">
                        <div className="d-flex justify-content-center mb-4">
                            <Nav className="nav nav-tabs mb-3 tab-style-6 bg-primary-transparent" id="myTab" role="tablist">
                                ...
                                <Nav.Item className="" role="presentation">
                                    <Nav.Link className="nav-link" id="pricing-yearly" data-bs-toggle="tab" eventKey="YEAR"
                        ...
                        <Card className="custom-card overflow-hidden">
                            <Card.Body className=" p-0">
                                <Tab.Content className="" id="myTabContent">
                                    <Tab.Pane className="p-0" id="pricing-monthly-pane" eventKey="MONTH"
                                        role="tabpanel" aria-labelledby="pricing-monthly" tabIndex={0}>
                                        <Row className="">
                                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 border-end border-inline-end-dashed pe-0">
                                                <div className="p-4">
                                                    ...
                                                    <div className="d-grid">
                                                        <Button variant='' className="btn btn-primary-light btn-wave" type="button">Get Started</Button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 border-end border-inline-end-dashed px-0">
                                                <div className="p-4">
                                            ...
                                            <div className="col-xxl-4 col-xl-4 col-lg-4 col-md-4 col-sm-12 ps-0">
                                                <div className="p-4 pricing-offer overflow-hidden">
                                                    ...
                                                    <div className="d-grid">
                                                        <Button variant='' className="btn btn-primary btn-wave" type="button">Get Started</Button>
                                                    </div>
                                                </div>
                                            </div>
                                        </Row>
                                    </Tab.Pane>
                                    <Tab.Pane className="p-0" id="pricing-yearly-pane" eventKey="YEAR"
            ...
            <Row className=" justify-content-center">
                <div className="col-xxl-10 col-xl-12 col-md-12 col-lg-12 col-sm-12">
                    <Row className=" justify-content-center">
                        <div className="col-xl-9">
                            ...
                            <div className="table-responsive">
                                <Table className="table table-bordered text-nowrap">
                                    <thead>
                                        <tr>
                                            <th scope="col">
                                                <span className="fs-15 fw-semibold">Check Our Plans</span>
                                            </th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td className="border-bottom-0">
                                                <Button variant='' className="btn btn-primary btn-wave" type="button">Choose
                                                    Plan</Button>
                                            </td>
                                            <td className="border-bottom-0">
                                                <Button variant='' className="btn btn-primary btn-wave" type="button">Choose
