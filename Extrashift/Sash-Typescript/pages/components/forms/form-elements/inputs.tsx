...
const Inputs = () => {
	return (
		<Fragment>
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Input Types"  customCardBodyClass="" code={input1}>
						<div className="row gy-4">
							<Col xl={4} lg={6} md={6} sm={12}>
								<Form.Label className="" htmlFor="input-text">Basic Input:</Form.Label>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Input shapes"  customCardBodyClass="" code={input2}>
				...
				<Col xl={6}>
					<ShowCode title="Input border Styles"  customCardBodyClass="" code={input3}>
						<div className="row gy-3">
							<Col xl={12}>
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Input Sizing"  customCardBodyClass="" code={input4}>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Overview"  customCardBodyClass="" code={input5}>
						<Form>
							<div className="mb-3">
				...
				<Col xl={6}>
					<Row>
						<Col xl={12}>
							<ShowCode title="Form text"  customCardBodyClass="" code={input6}>
						...
						<Col xl={12}>
							<ShowCode title=" Inline text can use any typical inline HTML element with nothing more
                                                than
                                                the <span class='text-danger'>.form-text</span> class."  customCardBodyClass="" code={input7}>
				...
				<Col xl={6}>
					<ShowCode title="Disabled forms"  customCardBodyClass="" code={input8}>
						<Form>
							<fieldset disabled>
