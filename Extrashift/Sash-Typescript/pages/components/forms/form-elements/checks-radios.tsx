		...
		<Fragment>
			...
			<Row>
				<Col xl={3} lg={6} md={6} sm={12}>
					<ShowCode title="Checks"  customCardBodyClass="" code={radio1}>
				...
				<Col xl={3} lg={6} md={6} sm={12}>
					<ShowCode title="Disabled"  customCardBodyClass="" code={radio2}>
				...
				<Col xl={3} lg={6} md={6} sm={12} >
					<ShowCode title="Radios"  customCardBodyClass="" code={radio3}>
				...
				<Col xl={3} lg={6} md={6} sm={12} >
					...
					<ShowCode title="Disabled"  customCardBodyClass="" code={radio4}>
			...
			<Row>
				<Col xl={6} lg={6} md={12} sm={12}>
					<ShowCode title="Default (stacked)"  customCardBodyClass="" code={radio5}>
						<Form.Check label="Default checkbox" />
						<Form.Check disabled label="Disabled checkbox" />
				...
				<Col xl={6} lg={6} md={12} sm={12}>
					<ShowCode title="Switches"  customCardBodyClass="" code={radio6}>
			...
			<Row>
				<Col xxl={4} xl={12} lg={12} md={12} sm={12}>
					<ShowCode title="Checkbox Sizes"  customCardBodyClass="d-sm-flex align-items-center justify-content-between" code={radio13}>
				...
				<Col xxl={4} xl={12} lg={12} md={12} sm={12} className="">
					<ShowCode title="Radio Sizes"  customCardBodyClass="d-sm-flex align-items-center justify-content-between" code={radio14}>
				...
				<Col xxl={4} xl={12} lg={12} md={12} sm={12} className="">
					<ShowCode title="Switch Sizes"  customCardBodyClass="d-sm-flex align-item-center justify-content-between" code={radio15}>
			...
			<Row>
				<Col xl={6} lg={12} md={12} sm={12}>
					<ShowCode title="Inline"  customCardBodyClass="" code={radio9}>
					...
					<ShowCode title="Without labels"  customCardBodyClass="" code={radio10}>
				...
				<Col xl={3} lg={12} md={12} sm={12}>
					<ShowCode title="Reverse"  customCardBodyClass="" code={radio11}>
				...
				<Col xl={3} lg={12} md={12} sm={12} className="">
					<ShowCode title="Outlined styles"  customCardBodyClass="" code={radio12}>
			...
			<Row>
				<div className="col-xl-6 col-lg-12 col-md-12 col-sm-12">
					<ShowCode title="Radio toggle buttons"  customCardBodyClass="" code={radio7}>
				...
				<Col xl={6} lg={12} md={12} sm={12}>
					<ShowCode title="Checkbox toggle buttons"  customCardBodyClass="" code={radio8}>
			...
			<div className="row row-cols-12">
				<div className="col">
					<ShowCode title="Colored Checkboxes"  customCardBodyClass="" code={radio20}>
						{Checkdata1.map((idx) => (
							<div className={`form-check ${idx.class1}`} key={Math.random()}>
								...
								<Form.Label className=''>{idx.text}</Form.Label>
							</div>
						))}
					</ShowCode>
				</div>
				<div className="col">
					<ShowCode title="Outline Checkboxes"  customCardBodyClass="" code={radio21}>
						{Checkdata1.map((idx) => (
							<div className={`form-check ${idx.class1}`} key={Math.random()}>
				...
				<div className="col">
					<ShowCode title="Colored Radios"  customCardBodyClass="" code={radio22}>
						{Checkdata1.map((idx) => (
							<div className={`form-check ${idx.class1}`} key={Math.random()}>
				...
				<div className="col">
					<ShowCode title="Outline Radios"  customCardBodyClass="" code={radio23}>
						{Checkdata1.map((idx) => (
							<div className={`form-check ${idx.class1}`} key={Math.random()}>
								<input id={idx.id} className={`form-check-input form-checked-outline form-checked-${idx.class2}`}
									type="radio" defaultChecked />
				...
				<div className="col">
					<ShowCode title="Switches Colors"  customCardBodyClass="" code={radio24}>
						{Checkdata1.map((idx) => (
			...
			<Row>
				<Col xl={6} lg={6} md={6} sm={12}>
					<ShowCode title="Toggle Switches Style-1"  customCardBodyClass="" code={radio16}>
				...
				<Col xl={6} lg={6} md={6} sm={12}>
					<ShowCode title="Toggle Switches Style-2"  customCardBodyClass="" code={radio17}>
			...
			<Row>
				<Col xl={6} lg={6} md={6} sm={12} className="">
					<ShowCode title="Toggle Switch-1 Sizes"  customCardBodyClass="" code={radio18}>
				...
				<Col xl={6} lg={6} md={6} sm={12} className="">
					<ShowCode title="Toggle Switch-2 Sizes"  customCardBodyClass="" code={radio19}>
