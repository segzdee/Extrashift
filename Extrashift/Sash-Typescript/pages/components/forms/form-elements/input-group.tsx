...
const Inputgroup = () => {
	return (
		<Fragment>
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Input Groups"  customCardBodyClass="" code={inputgroup1}>
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Warpping"  customCardBodyClass="" code={inputgroup11}>
			...
			<Row>
				<Col xl={6}>
					<Row>
						<Col xl={12}>
							<ShowCode title="Sizing"  customCardBodyClass="" code={inputgroup2}>
						...
						<Col xl={12}>
							<ShowCode title="Buttons addons"  customCardBodyClass="" code={inputgroup3}>
								<InputGroup className="mb-3">
						...
						<Col xl={12}>
							<ShowCode title="Buttons with dropdowns"  customCardBodyClass="" code={inputgroup4}>
								<InputGroup className="mb-3">
									<Dropdown>
						...
						<Col xl={12}>
							<ShowCode title="Custom file input"  customCardBodyClass="" code={inputgroup5}>
								<InputGroup className="mb-3">
									<Form.Label className="input-group-text mb-0" htmlFor="inputGroupFile01">Upload</Form.Label>
								...
								<InputGroup className="mb-3">
									...
									<Form.Label className="input-group-text mb-0" htmlFor="inputGroupFile02">Upload</Form.Label>
								</InputGroup>

								<InputGroup className="mb-3">
									<Button variant='' className="btn py-1 btn-primary" type="button"
				...
				<Col xl={6}>
					<Row>
						<Col xl={12}>
							<ShowCode title="Multiple inputs"  customCardBodyClass="" code={inputgroup6}>
								<InputGroup>
						...
						<Col xl={12}>
							<ShowCode title="Checkboxes and radios"  customCardBodyClass="" code={inputgroup7}>
								<InputGroup className="mb-3">
									<InputGroup.Text className="">
						...
						<Col xl={12}>
							<ShowCode title="Multiple addons"  customCardBodyClass="" code={inputgroup8}>
								<InputGroup className="mb-3">
									<InputGroup.Text className="">
										<Form.Check className="mt-0" type="checkbox" value=""
											aria-label="Checkbox for following text input" />
						...
						<Col xl={12}>
							<ShowCode title="Segmented buttons"  customCardBodyClass="" code={inputgroup9}>
								<InputGroup className="mb-3">
						...
						<Col xl={12}>
							<ShowCode title="Custom select"  customCardBodyClass="" code={inputgroup10}>
								<InputGroup className="mb-3">
									<Form.Label className="input-group-text mb-0" htmlFor="inputGroupSelect01">Options</Form.Label>
								...
								<InputGroup className="mb-3">
									...
									<Form.Label className="input-group-text mb-0" htmlFor="inputGroupSelect02">Options</Form.Label>
								</InputGroup>
								<InputGroup className="mb-3">
