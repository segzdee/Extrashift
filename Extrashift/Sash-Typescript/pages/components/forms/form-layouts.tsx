import { layout1, layout10, layout11, layout2, layout3, layout4, layout5, layout6, layout7, layout8, layout9 } from '@/shared/data/prismdata/forms-prism'
...
const Formlayouts = () => {
	return (
		<Fragment>
			...
			<Pageheader title="Form Layouts" heading="Form Elements" active="Form Layouts" />
			<Row>
				<Col xl={6}>
					<ShowCode title="Vertical Forms"  customCardBodyClass="" code={layout1}>
						<div className="mb-3">
				...
				<Col xl={6}>
					<ShowCode title="Horizontal form"  customCardBodyClass="" code={layout2}>
						<form>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title=" Vertical Forms with icon"  customCardBodyClass="" code={layout7}>
						<div className="mb-3">
				...
				<Col xl={6}>
					<ShowCode title="Horizontal form With Icons"  customCardBodyClass="" code={layout8}>
						<Form>
							<Row className="mb-3">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Inline forms"  customCardBodyClass="" code={layout3}>
						<Form className="row row-cols-lg-auto g-3 align-items-center">
							<div className="col-12">
								<Form.Label className="visually-hidden"
									htmlFor="inlineFormInputGroupUsername">Username</Form.Label>
								<InputGroup>
							...
							<div className="col-12">
								<Form.Label className="visually-hidden"
									htmlFor="inlineFormSelectPref">Preference</Form.Label>
				...
				<Col xl={6}>
					<ShowCode title="Column sizing"  customCardBodyClass="" code={layout4}>
						<Row className="g-3">
							<Col sm={7} className="">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Utilities"  customCardBodyClass="" code={layout5}>
						<div className="mb-3">
				...
				<Col xl={6}>
					<ShowCode title="Horizontal form label sizing"  customCardBodyClass="" code={layout6}>
						<Row className="mb-3">
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Auto sizing"  customCardBodyClass="" code={layout9}>
						...
						<Form className="row gx-3 gy-2 align-items-center mt-0">
							<Col sm={3} className="">
								<Form.Label className="visually-hidden"
									htmlFor="specificSizeInputName">Name</Form.Label>
								<Form.Control type="text" className="form-control" id="specificSizeInputName"
									placeholder="Jane Doe" />
							</Col>
							<Col sm={3} className="">
								<Form.Label className="visually-hidden"
									htmlFor="specificSizeInputGroupUsername">Username</Form.Label>
								<InputGroup>
									<InputGroup.Text className="input-group-text">@</InputGroup.Text>
									<Form.Control type="text" className="form-control"
							...
							<Col sm={3} className="">
								<Form.Label className="visually-hidden"
									htmlFor="specificSizeSelect">Preference</Form.Label>
			...
			<Row>
				<Col xxl={6}>
					<ShowCode title="Form grid"  customCardBodyClass="" code={layout10}>
						<Row>
				...
				<Col xxl={6}>
					<ShowCode title="Gutters"  customCardBodyClass="" code={layout11}>
