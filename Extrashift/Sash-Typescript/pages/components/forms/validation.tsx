...
const Validation = () => {
	...
	return (
		<Fragment>
			...
			<Pageheader title="Validations" heading="Forms" active="Validations" />
			<Row>
				<Col xl={6}>
					<ShowCode title="Custom Validation"  customCardBodyClass="" code={validation1}>
				...
				<Col xl={6}>
					<ShowCode title="Browser default Validation"  customCardBodyClass="" code={validation2}>
			...
			<Row>
				<Col xl={6}>
					<Row>
						<Col xl={12}>
							<ShowCode title="Server side Validation"  customCardBodyClass="" code={validation3}>
								<Form className="row g-3">
									<Col md={4}>
						...
						<Col xl={12}>
							<ShowCode title="Tooltips"  customCardBodyClass="" code={validation4}>
								<Formik
				...
				<Col xl={6}>
					<ShowCode title="Supported elements"  customCardBodyClass="" code={validation5}>
