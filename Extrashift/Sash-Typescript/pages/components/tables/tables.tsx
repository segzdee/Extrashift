...
import { Table10data, Table11data, Table12data, Table13data, Table1data, Table2data, Table3data, Table4data, Table5data, Table6data, Table7data, Table8data, Table9data } from '@/shared/data/tables/tablesdata';
...
const Tables = () => {
	...
	return (
		<Fragment>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Basic Tables"  customCardBodyClass="" code={table1}>
							...
							<Table className="table text-nowrap">
								...
								<tbody>
									<tr>
										...
										<td>21,Dec 2023</td>
										<td>+1234-12340</td>
										<td><div className="badge bg-outline-primary">Completed</div></td>
									</tr>
									<tr>
										<th scope="row">Vareni</th>
										<td>29,April 2023</td>
										<td>+1523-12459</td>
										<td><div className="badge bg-outline-secondary">Failed</div></td>
									</tr>
									<tr>
										<th scope="row">Sasra</th>
										<td>30,Nov 2023</td>
										<td>+1982-16234</td>
										<td><div className="badge bg-outline-success">Successful</div></td>
									</tr>
									<tr>
										<th scope="row">Widoyi</th>
										<td>18,Mar 2023</td>
										<td>+1526-10729</td>
										<td><div className="badge bg-outline-warning">Pending</div></td>
									</tr>
									<tr>
				...
				<Col xl={6}>
					<ShowCode title="Bordered Tables"  customCardBodyClass="" code={table2}>
						<div className="table-responsive">
										...
										<tr key={Math.random()}>
											...
											<td>
												<div className="hstack gap-2 fs-15">
													<a href="#!" className="btn btn-icon btn-sm text-info"><i className="ri-edit-line"></i></a>
													<a href="#!" className="btn btn-icon btn-sm text-danger"><i className="ri-delete-bin-line"></i></a>
												</div>
											</td>
										</tr>
									))}
			...
			<Row>
				<Col xl={4}>
					<ShowCode title=" Bordered Primary"  customCardBodyClass="" code={table11}>
						<div className="table-responsive">
				...
				<Col xl={4}>
					<ShowCode title="Bordered Success"  customCardBodyClass="" code={table12}>
						<div className="table-responsive">
				...
				<Col xl={4}>
					<ShowCode title="Bordered warning"  customCardBodyClass="" code={table13}>
						<div className="table-responsive">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Table Without Borders"  customCardBodyClass="p-0" code={table14}>
						<div className="table-responsive">
				...
				<Col xl={6}>
					<ShowCode title="Table Group Divideres"  customCardBodyClass="p-0" code={table15}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead>
									<tr>
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Striped rows"  customCardBodyClass="p-0" code={table3}>
						<div className="table-responsive">
								...
								<tbody>
									{Table2data.map((idx) => (
										<tr key={Math.random()}>
											...
											<td>
												<div className="hstack gap-2 fs-15">
													<Button variant='' className="btn btn-sm btn-success btn-wave waves-effect waves-light"> <i className="ri-download-2-line align-middle me-2 d-inline-block"></i>Download </Button>
												</div>
											</td>
										</tr>
									))}
				...
				<Col xl={6}>
					<ShowCode title="Striped columns"  customCardBodyClass="p-0" code={table4}>
						<div className="table-responsive">
								...
								<tbody>
									{Table2data.map((idx) => (
										<tr key={Math.random()}>
											...
											<td>
												<div className="hstack gap-2 fs-15">
													<Button variant='' className="btn btn-sm btn-danger btn-wave waves-effect waves-light"> <i className="ri-delete-bin-line align-middle me-2 d-inline-block"></i>Delete </Button>
												</div>
											</td>
										</tr>
									))}
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Primary Table"  customCardBodyClass="" code={table5}>
						<div className="table-responsive">
				...
				<Col xl={4}>
					<ShowCode title="Secondary Table"  customCardBodyClass="" code={table6}>
						<div className="table-responsive">
				...
				<Col xl={4}>
					<ShowCode title="Warning Table"  customCardBodyClass="" code={table7}>
						<div className="table-responsive">
				...
				<Col xl={4}>
					<ShowCode title="Danger Table"  customCardBodyClass="" code={table8}>
						<div className="table-responsive">
				...
				<Col xl={4}>
					<ShowCode title="Dark Table"  customCardBodyClass="" code={table9}>
						<div className="table-responsive">
				...
				<Col xl={4}>
					<ShowCode title="Success Table With Striped Rows"  customCardBodyClass="" code={table10}>
						<div className="table-responsive">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Hoverable Rows"  customCardBodyClass="p-0" code={table22}>
						<div className="table-responsive">
				...
				<Col xl={6}>
					<ShowCode title=" Hoverable rows With striped rows"  customCardBodyClass="p-0" code={table23}>
						<div className="table-responsive">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Table Head Primary"  customCardBodyClass="p-0" code={table16}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
				...
				<Col xl={6}>
					<ShowCode title="Table Head warning"  customCardBodyClass="p-0" code={table17}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
				...
				<Col xl={6}>
					<ShowCode title="Table Head Success"  customCardBodyClass="p-0" code={table18}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
				...
				<Col xl={6}>
					<ShowCode title="Table Head Info"  customCardBodyClass="p-0" code={table19}>
						<div className="table-responsive">
				...
				<Col xl={6}>
					<ShowCode title="Table Head Secondary"  customCardBodyClass="p-0" code={table20}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
				...
				<Col xl={6}>
					<ShowCode title="Table Head Danger"  customCardBodyClass="p-0" code={table21}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
			...
			<Row>
				<Col xl={4}>
					<ShowCode title="Table Foot"  customCardBodyClass="p-0" code={table26}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead className="table-primary">
									<tr>
				...
				<Col xl={4}>
					<ShowCode title="Table With Caption" customCardHeaderClass="border-0" customCardBodyClass="p-0" code={table27}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
				...
				<Col xl={4}>
					<ShowCode title="Table With Top Caption"  customCardBodyClass="p-0" code={table28}>
						<div className="table-responsive">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Active Tables"  customCardBodyClass="p-0" code={table24}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead>
									<tr>
				...
				<Col xl={6}>
					<ShowCode title="Small Tables"  customCardBodyClass="p-0" code={table25}>
						<div className="table-responsive">
			...
			<Row>
				<Col xl={6}>
					<ShowCode title="Color variants tables"  customCardBodyClass="p-0" code={table29}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead>
									<tr>
				...
				<Col xl={6}>
					<ShowCode title="Nesting"  customCardBodyClass="" code={table30}>
						<div className="table-responsive">
			...
			<Row>
				<Col xl={12}>
					<ShowCode title="Always responsive"  customCardBodyClass="p-0" code={table31}>
						<div className="table-responsive">
							<Table className="table text-nowrap">
								<thead>
									<tr>
										<th scope="col"><Form.Check className="" type="checkbox" id="checkboxNoLabel" value="" aria-label="..." /></th>
								...
								<tbody>
									<tr>
										<th scope="row"><Form.Check className="" type="checkbox" id="checkboxNoLabel1" value="" aria-label="..." /></th>
										<td>
											<div className="d-flex align-items-center">
												<span className="avatar avatar-xs me-2 online avatar-rounded">
									...
									<tr>
										<th scope="row"><Form.Check className="" type="checkbox" id="checkboxNoLabel2" value="" aria-label="..." /></th>
										<td>
											<div className="d-flex align-items-center">
												<span className="avatar avatar-xs me-2 online avatar-rounded">
									...
									<tr>
										<th scope="row"><Form.Check className="" type="checkbox" id="checkboxNoLabel3" value="" aria-label="..." /></th>
										<td>
											<div className="d-flex align-items-center">
												<span className="avatar avatar-xs me-2 online avatar-rounded">
									...
									<tr>
										<th scope="row"><Form.Check className="" type="checkbox" id="checkboxNoLabel13" value="" aria-label="..." /></th>
										<td>
											<div className="d-flex align-items-center">
												<span className="avatar avatar-xs me-2 online avatar-rounded">
													<img src="../../../assets/images/faces/5.jpg" alt="img" />
			...
			<Row>
				<Col xl={12} className="">
					<ShowCode title="Vertical alignment"  customCardBodyClass="p-0" code={table32}>
						<div className="table-responsive">
