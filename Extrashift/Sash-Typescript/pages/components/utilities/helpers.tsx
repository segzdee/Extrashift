						...
						<Card.Body>
							...
							<div className="card-body pb-0">
								...
								<p className="card-text">
									<Link href="#!" className="stretched-link text-danger"
								...
								<p className="card-text bg-light mb-0 p-1 rounded" style={{ transform: "rotate(0)" }}>
									This <Link href="#!" className="text-warning stretched-link">stretched
										link </Link>
					...
					<Card className="custom-card">
						...
						<Card.Body>
							<div className="d-flex justify-content-evenly flex-wrap">
								...
								<Link href="#!" className="link-light fw-semibold fs-15 p-1 bg-dark rounded-1">Light</Link>
