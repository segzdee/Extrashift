					...
					<Card className="custom-card">
						...
						<Card.Body>
							<p>The gutters between columns in our predefined grid classes can be removed
								with <span className="text-danger">.g-0</span>. This removes the negative <span
									className="text-danger">margins</span> from <span className="text-danger me-1 d-inline-flex">.row
								</span>and the horizontal <span className="text-danger me-1 d-inline-flex">padding</span>
