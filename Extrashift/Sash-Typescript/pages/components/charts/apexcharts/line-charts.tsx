import { Annotations, Basicline, Brushchart, Dashed, Gradientline, Linechartwithlabels, Missingnullvalues, Stepline, Syncing, Zoomabletime } from '@/shared/data/charts/apexcharts/linechartdata';
...
const Linecharts = () => {
    return (
        <Fragment>
            <Seo title={"Apex Line Chart"} />
            <Pageheader title="Apex Line Chart" heading="Apex Charts" active="Apex Line Chart" />
            <Row>
                <Col xl={6}>
